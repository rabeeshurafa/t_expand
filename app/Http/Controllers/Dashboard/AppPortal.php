...
order by created_at asc"); 
    ...
    public function viewTicketPortal($ticket_id=0)
	{
		   ...
		   if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=4;
                return view('dashboard.water_ticket.globalMalfunction', compact('ticket','type','ticketInfo','department','region','app_type','fees','archive_config','app_no'));
            }else{
                ...
                $app_no=4;
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                return view('dashboard.services.globalMalfunction', compact('ticket','type','region','ticketInfo','department','app_type','fees','app_no','archive_config'));
		...
		if($related==5){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=5;
                return view('dashboard.water_ticket.meterCheck', compact('ticket','type','ticketInfo','region','department','app_type','fees','archive_config','app_no'));
            }else{
                $subs=elec::where('elecs.enabled',1)->whereIn('elecs.id',$subsId)->select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','d.name as payType_name')
                    ->leftJoin('t_constant as a', 'a.id', 'elecs.subscription_Type')
		...
		if($related==6){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=6;
                return view('dashboard.water_ticket.disconnect', compact('ticket','type','ticketInfo','region','department','app_type','fees','archive_config','app_no'));
            }
            else
            $subs=elec::where('elecs.enabled',1)->whereIn('elecs.id',$subsId)->select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','d.name as payType_name')
                ->leftJoin('t_constant as a', 'a.id', 'elecs.subscription_Type')
		...
		if($related==7){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=7;
                return view('dashboard.water_ticket.reconnect', compact('ticket','type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
            }
            else{
                $subs=elec::where('elecs.enabled',1)->whereIn('elecs.id',$subsId)->select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','d.name as payType_name')
                    ->leftJoin('t_constant as a', 'a.id', 'elecs.subscription_Type')
		...
		if($related==8){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=8;
                return view('dashboard.water_ticket.waiveSubscription', compact('ticket','type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
            }
            else{
            $subs=elec::where('elecs.enabled',1)->whereIn('elecs.id',$subsId)->select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','d.name as payType_name')
                ->leftJoin('t_constant as a', 'a.id', 'elecs.subscription_Type')
		...
		if($related==9){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=9;
                return view('dashboard.water_ticket.meterRead', compact('ticket','type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
            }
            else{
		...
		if($related==10){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                $app_no=10;
                return view('dashboard.water_ticket.meterTransfer', compact('ticket','type','region','ticketInfo','department','app_type','fees','archive_config','app_no'));
            }
            else{
                $subs=elec::where('elecs.enabled',1)->where('elecs.id',$subsId)->select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','d.name as payType_name')
                    ->leftJoin('t_constant as a', 'a.id', 'elecs.subscription_Type')
		...
		if($related==11){
		    ...
		    if($ticket->app_type==2)
            {
                ...
                $app_no=11;
                $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
                return view('dashboard.water_ticket.FinancialTransfer', compact('ticket','type','ticketInfo','department','app_type','fees','archive_config','app_no'));
            }
            else
            $subs=elec::where('elecs.enabled',1)->where('elecs.id',$subsId)->select('elecs.*', 'users.name as user_name','a.name as subscription_Type_name','b.name as counter_Type_name','d.name as payType_name')
                ->leftJoin('t_constant as a', 'a.id', 'elecs.subscription_Type')
	    ...
	    if($related==23){
		  //  $ticket_name=Constant::select('name')->where('id',$ticket->task_type)->where('status',1)->first();
		  //  $ticket->setAttribute('task_type',$ticket_name->id);
    ...
    public function saveTicket24(TicketRequest7 $request){
        $app_id=$request->app_id;
        $ticket_type=24;
        $this->updateCMobile($request->subscriber_id,$request->MobileNo)  ;
