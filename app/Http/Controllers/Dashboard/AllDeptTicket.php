...
class AllDeptTicket extends Controller
{
    ...
    function getAllDeptticket()
    {
        ...
        $ticket36 = AppTicket36::where('ticket_status', '!=', 5003)->get();
        $ticket37 = AppTicket37::where('ticket_status', '!=', 5003)->get();
        $ticket38 = AppTicket38::where('ticket_status', '!=', 5003)->get();
        $ticket39 = AppTicket39::where('ticket_status', '!=', 5003)->get();
        $ticket40 = AppTicket40::where('ticket_status', '!=', 5003)->get();
        $ticket41 = AppTicket41::where('ticket_status', '!=', 5003)->get();
        $ticket42 = AppTicket42::where('ticket_status', '!=', 5003)->get();
        $ticket43 = AppTicket43::where('ticket_status', '!=', 5003)->get();
        $ticket44 = AppTicket44::where('ticket_status', '!=', 5003)->get();
        $ticket45 = AppTicket45::where('ticket_status', '!=', 5003)->get();
        $ticket46 = AppTicket46::where('ticket_status', '!=', 5003)->get();
        ...
        $ticket = $ticket1->mergeRecursive($ticket2)->mergeRecursive($ticket4)
                ...
                ->mergeRecursive($ticket35)->mergeRecursive($ticket36)->mergeRecursive($ticket37)
                ->mergeRecursive($ticket38)->mergeRecursive($ticket39)->mergeRecursive($ticket40)
                ->mergeRecursive($ticket41)->mergeRecursive($ticket42)->mergeRecursive($ticket43)
                ->mergeRecursive($ticket44)->mergeRecursive($ticket45)->mergeRecursive($ticket46);
        ...
        for ($i = 0; $i < count($ticket); $i++) {
            $res = AppTrans::where('app_trans.id', $ticket[$i]['active_trans'])->join('ticket_configs',
                    function ($join) {
