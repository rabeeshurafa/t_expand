...
class BuildingTicketController extends Controller
{
    ...
    public function straightening()
    {
        ...
        $app_no = 20;
        return view('dashboard.building_ticket.straightening',
                compact('type', 'region', 'ticketInfo', 'department', 'fees', 'archive_config', 'app_no'));
    }
    ...
    public function ownershipTransfer()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no = 35;
        return view('dashboard.building_ticket.ownershipTransfer',
                compact('type', 'region', 'ticketInfo', 'department', 'fees', 'archive_config', 'app_no'));
    }
    ...
    public function retrieveLic()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no = 26;
        return view('dashboard.building_ticket.retrieve_lic',
                compact('type', 'region', 'ticketInfo', 'department', 'fees', 'archive_config', 'app_no'));
    }
    ...
    public function concrete()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no = 39;
        return view('dashboard.building_ticket.concrete',
                compact('type', 'workTypeList', 'componyList', 'region', 'officeAreaList', 'ticketInfo', 'department',
                        'fees', 'archive_config', 'app_no', 'buildingTypes'));
    }
    ...
    public function tichet40()
    {
        ...
        return view('dashboard.building_ticket.tichet40',
                compact('type', 'useList', 'region', 'ticketInfo', 'department', 'fees', 'archive_config', 'app_no',
                        'attatches', 'officeAreaList', 'officeEngList', 'attachesCount'));
    }
    ...
    public function licenseFile()
    {
        ...
        return view('dashboard.building_ticket.licenseFile',
                compact('type', 'buildingTypeList', 'region', 'officeAreaList', 'ticketInfo', 'department', 'fees',
                        'archive_config', 'app_no', 'attatches', 'attachesCount'));
    }
    ...
    public function buildingLicense()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no = 18;
        return view('dashboard.building_ticket.buildingLicense',
                compact('docs1Count', 'docs2Count', 'docs3Count', 'docs1', 'docs2', 'docs3', 'type', 'app_type',
                        'officeAreaList', 'buildingStatusList'
                        , 'buildingTypeList', 'region', 'ticketInfo', 'department', 'fees', 'archive_config',
                        'app_no'));
    }
    ...
    public function sitePlan()
    {
        ...
        $archive_config = ArchiveRole::where('empid', Auth()->user()->id)->where('type', $type)->get();
        $app_no = 21;
        return view('dashboard.building_ticket.sitePlan',
                compact('type', 'ticketInfo', 'department', 'fees', 'archive_config', 'app_no', 'attatches',
                        'attachesCount'));
    }
    ...
    public function engineeringValidation()
    {
        ...
        return view('dashboard.building_ticket.engineeringValidation',
                compact('type', 'region', 'officeAreaList', 'buildingTypeList', 'ticketInfo', 'department', 'fees',
