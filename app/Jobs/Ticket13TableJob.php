...
class Ticket13TableJob implements ShouldQueue
{
    ...
    public function handle() {
        ...
        $client['CurrVas']              = @$obj['fk_i_new_vas'];
        $client['CurrAmpere']           = @$obj['i_new_ampere'];
        $client['NewAmpere']            = @$obj['i_new_ampere'];
