                                        ...
                                        <div class="card-header">
                                            <div class="row rowMargin">
                                               {{-- <div class="col-sm-2 imgAvatar">
                                                ...
                                                <div class="col-sm-12 infoAvatar infoAvataronmob" style="">
                                                    <a style="font-size: 20px !important;"
                                                        href="{{ route('admin.dashboard')}}/alldeptticket/id/{{$department['id']}}">
                                                        {{$department->name}} </a>
                                                    <span class="badge badge-pill badge-danger badge-up badge-glow"
                                                        style="top: 0px;">{{$department['tiketCount']}}</span>
                                            ...
                                            <div class="card-body" style="    padding: 0.5rem">
                                                <div class="cardSize" style="direction: ltr">
                                                    <table width="100%" style="direction: rtl" class="">
                                                        <tbody>
                                                            @for($i=0 ; $i<$department['tiketCount'] ; $i++)
                                                            <tr style="@if ($i % 2 ==0)background-color:#FFFFFF; @else  background-color:#D7EDF9; @endif">
                                                                <td align="right"
                                                                    ...
                                                                    {{$department['ticket'][$i]['customer_name']}}
                                                                </td>
                                
                                                                <td
                                                                    style="    text-align: right;color:#000;font-size: 17px !important;">
                                                                    <a target="_blank" href="{{ route('admin.dashboard')}}/viewTicket/{{$department['ticket'][$i]['id']}}/{{$department['ticket'][$i]['Trans']['related']}} ">
                                                                        <?php if($department['ticket'][$i]->taskName !=null){ ?>
                                                                        {{$department['ticket'][$i]['taskName']}}
                                                                        <?php }else{ ?>
                                                                        {{$department['ticket'][$i]['Trans']['ticket_name']}}
                                                                        <?php } ?>
                                                                    <span class="hideMob">({{$department['ticket'][$i]['app_no']}})</span></a>
                                                                </td>
                                                                <td
