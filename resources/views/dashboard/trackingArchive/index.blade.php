                        ...
                        <div class="card-content collapse show">
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-body">
                                    ...
                                    @if($archive['info']->url == 'out_archieve'||$archive['info']->url == 'in_archieve')
                                        @include('dashboard.trackingArchive.component.outArchive')
                                    @elseif($archive['info']->url == 'trade_archive')
                                        @include('dashboard.trackingArchive.component.tradeArchive')
                                    @elseif($archive['info']->url == 'finance_archive')
