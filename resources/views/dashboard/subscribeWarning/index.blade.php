                        ...
                        <div class="col-sm-12">
                            <div class="card leftSide">
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <img src="https://db.expand.ps/images/personal-information.png" width="32"
                                             height="32">
                                        اخطارات المواطنين
                                    </h4>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group w-s-87">
                                                            ...
                                                            <input type="text" id="subscriberName"
                                                                   ...
                                                                   placeholder="اسم المواطن" name="subscriberName">
                                                ...
                                                <div class="col-lg-2 col-md-12" style="padding-right: 0px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="date" name="date" data-mask="00/00/0000"
                                                                   maxlength="10"
                                                                   class="form-control eng-sm singledate valid selectFullCorner"
                                                ...
                                                <div class="col-lg-2 col-md-12" style="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" style="width: 80% !important;">
                                                            ...
                                                            <select id="warningType" name="warningType" type="text"
                                                                    class="form-control valid warningType"
                                                                    style="height: 33px !important;"
                                                                    aria-invalid="false">
                                                            ...
                                                            <div class="input-group-append hidden-xs hidden-sm">
                                                                ...
                                                                <div class="input-group-append"
                                                                     onclick="ShowConstantModal(6228,'warningType','نوع الاخطار')">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group" style="width: 100% !important;">
                                                            ...
                                                            <input type="text" id="hodNo"
                                                                   class="form-control alphaFeild" name="hodNo"
                                                                   placeholder="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-1 col-md-6" style="padding-left: 0px;">
                                                    <div class="form-group">
                                                        <div class="input-group" style="width: 100% !important;">
                                                            ...
                                                            <input type="text" id="peiceNo"
                                                                   class="form-control alphaFeild" name="peiceNo"
                                                                   placeholder=" ">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-12" style="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" style="width: 80% !important;">
                                                            ...
                                                            <select id="receive" name="receive" type="text"
                                                                    class="form-control valid receive"
                                                                    style="height: 33px !important;"
                                                                    aria-invalid="false">
                                                            ...
                                                            <div class="input-group-append hidden-xs hidden-sm">
                                                                ...
                                                                <div class="input-group-append"
                                                                     onclick="ShowConstantModal(6265,'receive','نوع الاخطار')">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <table style="width:100%; margin-top: -10px;"
                                                            ...
                                                            <tr>
                                                                <td width="25%;">
                                                                    <input id="warningReason" name="warningReason"
                                                                           class="form-control eng-sm singledate valid selectFullCorner"
                                                                           placeholder="سبب الاخطار" autocomplete="off">
                                                                </td>
                                                                <td width="10%;">
                                                                    <div class="form-group form-group1"
                                                                        ...
                                                                        <div class="input-group"
                                                                            ...
                                                                            <select id="warningStatuse"
                                                                                    name="warningStatuse"
                                                                                    class="form-control selectFullCorner warningStatuse">
                                                                                <option value="0">اختر</option>
                                                                ...
                                                                <td width="25%;">
                                                                    <input id="deleteReason" name="deleteReason"
                                                                           class="form-control eng-sm singledate valid selectFullCorner"
                                                                           placeholder="سبب ازالة الاخطار"
                                                                           autocomplete="off">
                                                                </td>
                                                                <td width="10%;">

                                                                    <input id="deleteDate" name="deleteDate"
                                                    ...
                                                    <div class="form-group col-12 mb-2" style="padding-right: 0px;">
                                                        ...
                                                        <ol class="vasType 1vas addAttatch1">
                                                            <li style="font-size: 17px !important;color:#000000">
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <input type="text" id="attachName1_1"
                                                                               key="1"
                                                                               name="attachName1[]"
                                                                    ...
                                                                    <div class="col-sm-5 attach_row1_1">
                                                                        <input type="hidden" id="attach_ids1_1"
                                                        ...
                                                        <input type="hidden" id="attachfileName" name="attachfileName"
                                                               value="attachfile1">
                                                        <input type="file" style="display:none" id="attachfile1"
                                                               name="attachfile1" onchange="startUpload1('formData')">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group" style="">
                                            ...
                                            <select id="search_warningType" name="search_warningType" type="text"
                                                    class="form-control valid warningType" aria-invalid="false"
                                                    onchange="reload();">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="input-group" style="">
                                            ...
                                            <select id="search_warningStatuse" name="search_warningStatuse"
        ...
        <script>
            ...
            $.ajax({
              ...
              success: (response) => {
                ...
                var row = '<li style="font-size: 17px !important;color:#000000">' +
                  ...
                  `<input type="text" required id="attachName1_${attach_index1}" key="${attach_index1}" name="attachName1[]" class="form-control attachName1">` +
                  '</div>' +
                  ...
                  '</a>' +
                  `<input type="hidden" id="attach_ids1_${attach_index1}" name="attach_ids[]" value="${response.file.id}">` +
                  '<input type="hidden" id="notArchived[]" name="notArchived[]" value="' + response.file.id + '">' +
                  '</div>' +
                  '</div>' +
                  '</div>' +
                  '<div class="attdelmob">' +
                  `<img src="{{ asset('assets/images/ico/upload.png') }}" width="40" height="40" style="cursor:pointer" onclick="$('#currFile').val(${attach_index1});validateName1(${attach_index1})">` +
                  '</div>' +
                  '<div class="attdelmob">' +
          ...
          function resetFunction() {
            ...
            attachments = '<li style="font-size: 17px !important;color:#000000">'
              + '<div class="row">'
              + '<div class="col-sm-6" >'
              + '<input type="text" id="attachName1_1" key="1" name="attachName1[]" class="form-control attachName1" >'
              + '</div>'
              + '<div class="attdocmob col-sm-5 attach_row1_1" >'
              + `<input type="hidden" id="attach_ids1_1" name="attach_ids[]" value="">`
              + '</div>'
              + '<div>'
              + `<img src="{{ asset('assets/images/ico/upload.png') }}" width="40" height="40" style="cursor:pointer" onclick="$('#currFile1').val(1);validateName1(${1})">`
              + '</div>'
              + '</div>'
              + '</li>';
          ...
          function addNewAttatch1() {
            ...
            if ($(".attachName1").last().val().length > 0) {
              var row = '<li style="font-size: 17px !important;color:#000000">' +
                '<div class="row">' +
                '<div class="col-sm-6">' +
                `<input type="text" id="attachName1_${attach_index1}" name="attachName1[]" class="form-control attachName1">` +
                '</div>' +
            ...
            $.ajax({
              ...
              success: function (response) {
                ...
                if (response.info.file_ids != null) {
                  for (c = 0; c < response.info.Files.length; c++) {
                    ...
                    attachments += '<li style="font-size: 17px !important;color:#000000">'
                      + '<div class="row">'
                      + '<div class="col-sm-6" >'
                      + `<input type="text" required="" id="attachName1_${(c + 1)}" key="${(c + 1)}" name="attachName1[]" class="form-control attachName1" value="${attach.attachName}">`
                      + '</div>'
                      ...
                      + '</a>'
                      + `<input type="hidden" id="attach_ids1_${(c + 1)}" name="attach_ids[]" value="${attach.attach_ids}">`
                      + '</div>'
                      + '</div>'
                      + '</div>'
                      + '<div>'
                      + `<img src="{{ asset('assets/images/ico/upload.png') }}" width="40" height="40" style="cursor:pointer" onclick="$('#currFile1').val(${(c + 1)});validateName1(${(c + 1)})">`
                      + '</div>'
                      + '<div>'
                      + '<i class="fa fa-trash" id="plusElement1" style="padding-top:10px;position: relative;left: 3%;cursor: pointer;  color:#1E9FF2;font-size: 15pt; " onclick="$(this).parent().parent().parent().remove()"></i>'
                      + '</div>'
                ...
                attachments += '<li style="font-size: 17px !important;color:#000000">'
                  + '<div class="row">'
                  + '<div class="col-sm-6" >'
                  + `<input type="text" id="attachName1_${(c + 1)}" key="${(c + 1)}" name="attachName1[]" class="form-control attachName1" >`
                  + '</div>'
                  + '<div class="attdocmob col-sm-5 attach_row1_' + (c) + '" >'
                  + `<input type="hidden" id="attach_ids1_${(c)}" name="attach_ids[]" value="${attach.attach_ids}">`
                  + '</div>'
                  + '<div>'
                  + `<img src="{{ asset('assets/images/ico/upload.png') }}" width="40" height="40" style="cursor:pointer" onclick="$('#currFile1').val(${(c)});validateName1(${(c)})">`
                  + '</div>'
                  + '</div>'
                  + '</li>';
                $(".addAttatch1").html('')
