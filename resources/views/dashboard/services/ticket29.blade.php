                            ...
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text" id="kwatt" class="form-control"
                                                           @if(isset($ticket))
                                                               value="{{$ticket->kwatt}}" @endif placeholder=""
                                                           name="kwatt" style="height: 35px;">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group " style="padding-left: 47px;">
                                                    ...
                                                    <input type="text" id="placement" @if(isset($ticket))
                                                        value="{{$ticket->placement}}" @endif class="form-control"
                                                           placeholder="" name="placement" style="height: 35px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" id="licGroup"
                                                    ...
                                                    <input type="text" id="licNo" @if(isset($ticket))
                                                        value="{{$ticket->licNo}}" @endif  name="licNo"
                                                           class="form-control eng-sm " value="" placeholder=""
                                                           autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="margin-left: 0;">
                                        <div class="col-sm-12">
                                            <h5 class="sub-head" style="color:#ff9149;padding-bottom: 7px;"><b>بيانات
                                                    الأشتراك</b></h5>
                                            ...
                                            <table style="width:95%; margin-top: -10px;" class="detailsTB table">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col" style="text-align: -webkit-center;color: white;">
                                                        العداد
                                                    </th>
                                                    <th scope="col" style="text-align: -webkit-center;color: white;">وصف
                                                        مكان العداد
                                                    </th>
                                                    <th scope="col" style="color: white"></th>
