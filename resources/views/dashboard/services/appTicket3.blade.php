                                ...
                                <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" id="licGroup"
                                                    ...
                                                    <input type="text" id="LicenceNo" name="LicenceNo"
                                                           ...
                                                           value="@if(isset($ticket)){{($ticket->LicenceNo??'')}}@endif"
                                        ...
                                        <div class="input-group mb-2 col-lg-6 col-md-12">
                                            ...
                                            <div class="form-check-inline form-control">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" @if(isset($ticket))
                                                        {{$ticket->regionBuild ==1 ? 'checked' : ''}}
                                                    @endif value="1" name="regionbuild" id="regionbuild1">
                                                    خارج الحدود
                                                </label>
                                            </div>
                                            <div class="form-check-inline form-control">
                                                <label class="form-check-label">
                                                    <input type="checkbox"
                                                           @if(isset($ticket)){{$ticket->regionBuild == 2 ? 'checked' : ''}} @else checked
                                                           @endif class="form-check-input" value="2" name="regionbuild"
                                                           id="regionbuild2">داخل الحدود
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="hodNo" name="hodNo"
                                                           value="@if(isset($ticket)){{($ticket->hodNo??'')}}@endif"
                                        ...
                                        <div class="col-lg-3 col-md-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="pieceNo" name="pieceNo"
                                                       value="@if(isset($ticket)){{($ticket->pieceNo??'')}}@endif"
                                                       class="form-control " placeholder="  "
                                                       aria-describedby="basic-addon1">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="input-group mb-2 col-sm-12">
                                            ...
                                            <div class="form-check-inline form-control">
                                                <label class="form-check-label">
                                                    <input type="checkbox"
                                                           @if(isset($ticket)){{$ticket->typebuild == 1 ? 'checked' : ''}} @else checked
                                                           @endif id="typebuild1" name="typebuild" value="1"
                                                           class="form-check-input">بناء مقترح
                                                </label>
                                            </div>
                                            <div class="form-check-inline form-control">
                                                <label class="form-check-label">
                                                    <input type="checkbox" @if(isset($ticket))
                                                        {{$ticket->typebuild == 2 ? 'checked' : ''}}
                                                    @endif id="typebuild2" name="typebuild" value="2"
                                            ...
                                            <div class="form-check-inline form-control">
                                                <label class="form-check-label">
                                                    <input type="checkbox" @if(isset($ticket))
                                                        {{$ticket->typebuild == 3 ? 'checked' : ''}}
                                                    @endif id="typebuild3" name="typebuild" value="3"
                                    ...
                                    <div class="row">
                                        <table class="table table-bordered mb-3 st" style="text-align:center">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><input name="typestate"
                                                           @if(isset($ticket)){{$ticket->typestate ==1 ? 'checked' : ''}}@else checked
                                                           @endif id="typestate1" type="checkbox"
                                                           class="form-check-input" value="1"></td>
                                                <td><input name="typestate" @if(isset($ticket))
                                                        {{$ticket->typestate ==2 ? 'checked' : ''}}
                                                    @endif id="typestate2" type="checkbox" class="form-check-input"
                                                           value="2"></td>
                                                <td><input name="typestate" @if(isset($ticket))
                                                        {{$ticket->typestate ==3 ? 'checked' : ''}}
                                                    @endif id="typestate3" type="checkbox" class="form-check-input"
                                                           value="3"></td>
                                                <div class="form">
                                                    <td>
                                                        <input @if(isset($ticket)) {{$ticket->typebuilding ==1 ? 'checked' : ''}}@else checked
                                                               @endif name="typebuilding" id="typebuilding1"
                                                               type="checkbox" class="form-check-input" value="1"></td>
                                                    <td><input @if(isset($ticket))
                                                                   {{$ticket->typebuilding ==2 ? 'checked' : ''}}
                                                               @endif name="typebuilding" id="typebuilding2"
                                                               type="checkbox" class="form-check-input" value="2"></td>
                                                    <td><input @if(isset($ticket))
                                                                   {{$ticket->typebuilding ==3 ? 'checked' : ''}}
                                                               @endif name="typebuilding" id="typebuilding3"
                                                               type="checkbox" class="form-check-input" value="3"></td>
                                                    <td><input @if(isset($ticket))
                                                                   {{$ticket->typebuilding ==4 ? 'checked' : ''}}
                                                               @endif name="typebuilding" id="typebuilding4"
                                                               type="checkbox" class="form-check-input" value="4"></td>
                                                    <!--<input type="hidden" id="typebuilding" value="تجارية" name="typebuilding">-->
                                                    <td style="max-width:50px;background-color:#fff;">
                                                        <input type="text"
                                                               @if(isset($ticket))value="{{$ticket->typebuildingother}}"
                                                               @endif name="typebuildingother" id="typebuildingother"
                                                               class="form-control" placeholder=" اخرى  ">
                                                    </td>
                                                    <td style="max-width:300px">
                                                        <input type="text"
                                                               @if(isset($ticket))value="{{$ticket->typebuildingnote}}"
                                                               @endif class="form-control" value=""
                                                               name="typebuildingnote" id="typebuildingnote"
                                                               placeholder=" ملاحظات ">
                                                    </td>
                                                </div>
                                            </tr>
                                    ...
                                    <div class="row">
                                        <div class="form">
                                            <div class="input-group">
                                                <label class="form-label" style="color: #ff9149; font-weight:bold">مشتملات
                                                    العقار </label>
                                                <div class="col-sm-12 col-md-10">
                                                    <input onchange="if($(this).prop('checked'))$('.rent2').hide()"
                                                           type="radio" name="typeship" value="1"
                                                           @if(isset($ticket)) {{$ticket->typeship ==1 ? 'checked' : ''}}@else checked
                                                           @endif id="typeship1" class="jui-radio-buttons">
                                                    <label for="radio-3">العقار منفصل </label>
                                                    <input onchange="if($(this).prop('checked'))$('.rent2').show()"
                                                           type="radio" name="typeship" value="2" @if(isset($ticket))
                                                               {{$ticket->typeship ==2 ? 'checked' : ''}}
                                                           @endif id="typeship2" class="jui-radio-buttons">
                                    ...
                                    <div class="row rent2 @if(isset($ticket)) {{$ticket->typeship ==2 ? '' : 'hide'}}@else hide @endif ">
                                        <table class="table table-bordered mb-3 st" style="text-align:center">
                                            ...
                                            <tr>
                                                ...
                                                <td> 1.</td>
                                                <td> قائم</td>
                                                <td><input name="appart[]" @if(isset($ticket))
                                                        {{$ticket->detailData->appart ? in_array(1, $ticket->detailData->appart) ? 'checked' : '' : ''}}
                                                    @endif          id="appart1" type="checkbox"
                                                           class="form-check-input" value="1"></td>
                                                <td><input name="typeStore[]" @if(isset($ticket))
                                                        {{$ticket->detailData->typeStore ? in_array(1, $ticket->detailData->typeStore) ? 'checked' : '' : ''}}
                                                    @endif    id="typeStore1" type="checkbox" class="form-check-input"
                                                           value="1"></td>
                                                <td><input name="office[]" @if(isset($ticket))
                                                        {{$ticket->detailData->office ? in_array(1, $ticket->detailData->office) ? 'checked' : '' : ''}}
                                                    @endif          id="office1" type="checkbox"
                                                           class="form-check-input" value="1"></td>
                                                <td><input name="floor[]" @if(isset($ticket))
                                                        {{$ticket->detailData->floor ? in_array(1, $ticket->detailData->floor) ? 'checked' : '' : ''}}
                                                    @endif            id="floor1" type="checkbox"
                                                           class="form-check-input" value="1"></td>
                                                <td><input name="stairs[]" @if(isset($ticket))
                                                        {{$ticket->detailData->stairs ? in_array(1, $ticket->detailData->stairs) ? 'checked' : '' : ''}}
                                                    @endif          id="stairs1" type="checkbox"
                                                           class="form-check-input" value="1"></td>
                                                <td><input name="elev[]" @if(isset($ticket))
                                                        {{$ticket->detailData->elev ? in_array(1, $ticket->detailData->elev) ? 'checked' : '' : ''}}
                                                    @endif              id="elev1" type="checkbox"
                                                           class="form-check-input" value="1"></td>
                                                <td style="max-width:60px"><input type="text" name="notes1"
                                                                                  class="form-control"
                                                                                  @if(isset($ticket)) value="{{$ticket->detailData->notes1}}"
                                                                                  @endif placeholder=" ملاحظات "></td>
                                            ...
                                            <tr>
                                                ...
                                                <td> مرخص غير قائم</td>
                                                <td><input name="appart[]" @if(isset($ticket))
                                                        {{$ticket->detailData->appart ? in_array(2, $ticket->detailData->appart) ? 'checked' : '' : ''}}
                                                    @endif        id="appart2" type="checkbox" class="form-check-input"
                                                           value="2"></td>
                                                <td><input name="typeStore[]" @if(isset($ticket))
                                                        {{$ticket->detailData->typeStore ? in_array(2, $ticket->detailData->typeStore) ? 'checked' : '' : ''}}
                                                    @endif  id="typeStore2" type="checkbox" class="form-check-input"
                                                           value="2"></td>
                                                <td><input name="office[]" @if(isset($ticket))
                                                        {{$ticket->detailData->office ? in_array(2, $ticket->detailData->office) ? 'checked' : '' : ''}}
                                                    @endif        id="office2" type="checkbox" class="form-check-input"
                                                           value="2"></td>
                                                <td><input name="floor[]" @if(isset($ticket))
                                                        {{$ticket->detailData->floor ? in_array(2, $ticket->detailData->floor) ? 'checked' : '' : ''}}
                                                    @endif          id="floor2" type="checkbox" class="form-check-input"
                                                           value="2"></td>
                                                <td><input name="stairs[]" @if(isset($ticket))
                                                        {{$ticket->detailData->stairs ? in_array(2, $ticket->detailData->stairs) ? 'checked' : '' : ''}}
                                                    @endif        id="stairs2" type="checkbox" class="form-check-input"
                                                           value="2"></td>
                                                <td><input name="elev[]" @if(isset($ticket))
                                                        {{$ticket->detailData->elev ? in_array(2, $ticket->detailData->elev) ? 'checked' : '' : ''}}
                                                    @endif            id="elev2" type="checkbox"
                                                           class="form-check-input" value="2"></td>
                                                <td style="max-width:300px"><input type="text" name="notes2"
                                                                                   class="form-control"
                                                                                   @if(isset($ticket)) value="{{$ticket->detailData->notes2}}"
                                                                                   @endif placeholder=" ملاحظات "></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input name="appart[]" @if(isset($ticket))
                                                        {{$ticket->detailData->appart ? in_array(3, $ticket->detailData->appart) ? 'checked' : '' : ''}}
                                                    @endif        id="appart3" type="checkbox" class="form-check-input"
                                                           value="3"></td>
                                                <td><input name="typeStore[]" @if(isset($ticket))
                                                        {{$ticket->detailData->typeStore ? in_array(3, $ticket->detailData->typeStore) ? 'checked' : '' : ''}}
                                                    @endif  id="typeStore3" type="checkbox" class="form-check-input"
                                                           value="3"></td>
                                                <td><input name="office[]" @if(isset($ticket))
                                                        {{$ticket->detailData->office ? in_array(3, $ticket->detailData->office) ? 'checked' : '' : ''}}
                                                    @endif        id="office3" type="checkbox" class="form-check-input"
                                                           value="3"></td>
                                                <td><input name="floor[]" @if(isset($ticket))
                                                        {{$ticket->detailData->floor ? in_array(3, $ticket->detailData->floor) ? 'checked' : '' : ''}}
                                                    @endif          id="floor3" type="checkbox" class="form-check-input"
                                                           value="3"></td>
                                                <td><input name="stairs[]" @if(isset($ticket))
                                                        {{$ticket->detailData->stairs ? in_array(3, $ticket->detailData->stairs) ? 'checked' : '' : ''}}
                                                    @endif        id="stairs3" type="checkbox" class="form-check-input"
                                                           value="3"></td>
                                                <td><input name="elev[]" @if(isset($ticket))
                                                        {{$ticket->detailData->elev ? in_array(3, $ticket->detailData->elev) ? 'checked' : '' : ''}}
                                                    @endif            id="elev3" type="checkbox"
                                                           class="form-check-input" value="3"></td>
                                                <td style="max-width:300px"><input type="text" name="notes3"
                                                                                   class="form-control"
                                                                                   @if(isset($ticket)) value="{{$ticket->detailData->notes3}}"
                                                                                   @endif placeholder=" ملاحظات "></td>
                                            ...
                                            <tr style="display:none">
                                                ...
                                                <td> 4.</td>
                                                <td> المجموع</td>
                                                <td><input name="appart[]" id="appart4" type="checkbox"
                                                           class="form-check-input" value="4"></td>
                                                <td><input name="typeStore[]" id="typeStore4" type="checkbox"
                                                           class="form-check-input" value="4"></td>
                                                <td><input name="office[]" id="office4" type="checkbox"
                                                           class="form-check-input" value="4"></td>
                                                <td><input name="floor[]" id="floor4" type="checkbox"
                                                           class="form-check-input" value="4"></td>
                                                <td><input name="stairs[]" id="stairs4" type="checkbox"
                                                           class="form-check-input" value="4"></td>
                                                <td><input name="elev[]" id="elev4" type="checkbox"
                                                           class="form-check-input" value="4"></td>
                                                <td style="max-width:300px"><input type="text" name="notes4"
                                                                                   class="form-control"
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-sm-12 col-md-8">
                                                        ...
                                                        <input
                                                                ...
                                                                @if(isset($ticket)) {{ $ticket->ownership_type==1?"checked":"" }} @else checked
                                                                @endif
                                                        ...
                                                        <input
                                                                ...
                                                                class="jui-radio-buttons" value="2" @if(isset($ticket))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 ownertypes rent"
                                             @if(isset($ticket)) {{ $ticket->ownership_type==2?'':'style="display: none;"' }}@else style="display: none;" @endif >
                                            <div class="form-group">
