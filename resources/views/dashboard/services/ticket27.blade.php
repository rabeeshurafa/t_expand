                                            ...
                                            <div class="form-group paddmob">
                                                <div class="input-group">
                                                    ...
                                                    <select id="task_type" name="task_type" type="text"
                                                            ...
                                                            aria-invalid="false">
                                                        <option value="1" @if(isset($ticket))
                                                            {{$ticket->task_type==1?'selected':''}}
                                                        @else
                                                            selected=""
                                                                @endif > تركيب وحدات انارة
                                                        </option>
                                                        <option @if(isset($ticket))
                                                                    {{$ticket->task_type==2?'selected':''}}
                                                                @endif value="2"> اصلاح وحدات انارة
                                                        </option>
                                                        @foreach($fixTypeList as $fixtype)
                                                            <option
                                                                    value="{{ $fixtype->id }}" @if(isset($ticket))
                                                                {{$ticket->task_type==$fixtype->id?'selected':''}}
                                                                    @endif>{{ $fixtype->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-group-append hidemob"
                                                         onclick="ShowConstantModal(6064,'fixType','نوع الطلب')">
