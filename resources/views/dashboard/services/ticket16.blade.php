                        ...
                        <div class="card-content collapse show">
                            ...
                            <div class="card-body" style="padding-bottom: 0px;">
                                ...
                                <div class="form-body">
                                            ...
                                            <table style="width:95%; margin-top: -10px;" class="detailsTB table">
                                                <tr>
                                                    ...
                                                    <th style="color: #fff;" scope="col"
                                                        style="text-align: -webkit-center;">العداد
                                                    </th>
                                                    <th style="color: #fff;" scope="col"
                                                        style="text-align: -webkit-center;">وصف مكان العداد
                                                    </th>
                                                    <th style="color: #fff;" scope="col"></th>
                                    ...
                                    <div class="row hide">
                                        <div class="col-md-6">
                                            <input type="radio" id="upVas" name="upType[]"
                                                   class="jui-radio-buttons hide" value="1" checked onclick=""/>
                                            <label for="upVas" class="hide">
                                                رفع قدرة من 1 فاز إلى 3 فاز
                                            </label>
                                            <input type="radio" id="upAmpere" name="upType[]" class="jui-radio-buttons"
                                                   value="2" onclick=""/>
                                            <label for="upVas">
                                                زيادة أمبيرات
                                            </label>
                                        ...
                                        <div class="col-md-4 hide">
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" style="width:99% !important;">
                                                    ...
                                                    <select id="CurrVas1" name="CurrVas1" class="form-control valid"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" style="width:99% !important;">
                                                    ...
                                                    <input type="number" id="CurrAmpere1" name="CurrAmpere1"
                                                           class="form-control numFeild" value="32" onblur=" "
                                                           onchange=" ">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" style="width:99% !important;">
                                                    ...
                                                    <input type="number" id="NewAmpere1" name="NewAmpere1"
                                                           class="form-control numFeild NewAmpere1" value="32"
                                                           onblur=" " onchange=" ">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" style="width:99% !important;">
                                                    ...
                                                    <select id="CurrVas" name="CurrVas" class="form-control valid"
                                                            aria-invalid="false" onchange="changeVasTitle();">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" style="width:99% !important;">
                                                    ...
                                                    <input type="number" id="CurrAmpere" name="CurrAmpere"
                                                           class="form-control numFeild" value="32">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="input-group licNoGroup" style="width:99% !important;">
                                                    ...
                                                    <input type="number" id="NewAmpere" name="NewAmpere"
                                                           class="form-control numFeild NewAmpere" value="0"
                                                           onblur="calcAmpereCost()" onchange="calcAmpereCost()">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
