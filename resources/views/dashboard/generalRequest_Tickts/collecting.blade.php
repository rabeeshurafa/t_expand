                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group" style="width: 168px  !important;">
                                                    ...
                                                    <select id="CurrencyID1" name="CurrencyID1" type="text" class="form-control valid" style="margin-left: 15px;height: 38px !important;" aria-invalid="false">
                                        ...
                                        <div class="col-md-8" style="padding-left: 45px">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" readonly  id="moneyText" class="form-control" placeholder="" name="moneyText">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group paddmob">
                                                <div class="input-group">
                                                    ...
                                                    <textarea type="text" id="payfor" required="" class="form-control"
                                                        placeholder="" name="payfor" style="height: 70px;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
