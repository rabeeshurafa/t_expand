                        ...
                        <div class="card-content collapse show">
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group paddmob">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" onblur="calcDuration()"
                                                           value="<?php echo date('d/m/Y')?>"
                                            ...
                                            <div class="form-group paddmob">
                                                <table style="width:100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="tdborder" style="text-align: center" id="r_balance">
                                                            0
                                                        </td>
                                                        <td class="tdborder" style="text-align: center" id="r_spent">0
                                                        </td>
                                                        <td class="tdborder" style="text-align: center" id="r_remain">
                                                            0
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="tdborder" style="text-align: center" id="u_balance">
                                                            0
                                                        </td>
                                                        <td class="tdborder" style="text-align: center" id="u_spent">0
                                                        </td>
                                                        <td class="tdborder" style="text-align: center" id="u_remain">
                                                            0
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                    ...
                                    @include('dashboard.includes.maldesc_ticket',['name_maldesc'=>'سبب الاجازة'])
                                </div>
                            </div>
