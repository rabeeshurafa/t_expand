                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="padding-left: 0px; width: 100% !important;">
                                                    ...
                                                    <textarea type="text" id="malDesc" class="form-control"
                                                        placeholder="{{isset($name_maldesc)?$name_maldesc:'الموضوع'}}"name="malDesc"
                                                        style="width:100% ; border-radius:5px !important;height: 200px;"
                                                        aria-invalid="false">@if(isset($ticket)){{ $ticket->malDesc }}@elseبالإشارة إلى الموضوع أعلاه@endif</textarea>
