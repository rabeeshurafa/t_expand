        ...
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <input readonly type="text" id="subscriber_name" 
                    class="form-control numFeild" name="subscriber_name" value="{{ $ticket->customer_name }}">
    ...
    <div class="col-md-8" style="">
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <input {{ $readonly?"readonly":"" }} type="text" id="subscriber_name1" 
                    class="form-control numFeild" name="subscriber_name1" value="{{ $ticket->customer_name1 }}">
