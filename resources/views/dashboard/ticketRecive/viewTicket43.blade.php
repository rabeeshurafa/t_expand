        ...
        <div class="form-group">
            <div class="input-group" style="">
                ...
                <select id="task_type" {{ $readonly?"readonly":"" }}  name="task_type" type="text"
                    ...
                    <option value=""> {{ 'نوع الشكوي' }} </option>
                ...
                <div class="input-group-append hidemob"onclick="ShowConstantModal(6405,'ticket_type','نوع الشكوي')">
                    <span class="input-group-text input-group-text2">
                        <i class="fa fa-external-link"></i>
                    </span>
                </div>
        ...
        <div class="form-group">
            <div class="input-group" style="">
                ...
                <textarea {{ $readonly?"readonly":"" }} type="text" id="malDesc" class="form-control"
                    placeholder="وصف الشكوي" name="malDesc"
