...
@section('content')
                            ...
                            <h4 class="card-title">
                                <div class="row" style="margin-right: 15px;">
                                    ...
                                    @if($config[0]->ticket_no==32)
                                            <img class="hidemob"
                                                 src="https://t.expand.ps/expand_repov1/public/assets/images/exit.png"
                                                 width="32" height="32">
                                        @elseif($config[0]->ticket_no==34)
                                            <img src="https://t.expand.ps/expand_repov1/public/assets/images/purchase.png"
                                                 width="32" height="32">
                                        @else
                                            <img class="hidemob"
                                                 src="{{  asset('assets/images/'.$config[0]->ticket_ico)}}" width="32"
                                                 height="32">
                                        @endif
                                    </span>
                                    <span>
                                        ...
                                        <time style="font-size:10pt;display:block;padding-top:10px"
                                              class="fs14"><?php echo $arrDays[date('l',
                                                            strtotime($ticket->created_at))].' '.date('Y/m/d - H:i',
                                                            strtotime($ticket->created_at)); ?></time>
                                        ...
                                        @can('taskCitizenArchive')
                                            @if( $config[0]->show_archive==1)
                                                <img src="https://db.expand.ps/images/msg.png"
                                                     class="hidemob"
                                                     onclick="$('#msgModal').modal('show');$('#ArchModalName').html($('#subscriber_name').val());"
                                                     style="cursor:pointer;float:left;margin-top:5px;width:32px;height:32px;margin-left: 20px;">
                                            @endif
                                        @endcan
                                        @can('taskCitizenJob')
                                            @if( $config[0]->joblic_btn==1)
                                                <img src="https://db.expand.ps/images/ico6.jpg"
                                                     onclick="" class="hidemob"
                                                     style="cursor:pointer;float:left;margin-top:5px;width:32px;height:32px;margin-left: 20px;">
                                            @endif
                                        @endcan
                                        @if( $config[0]->apps_btn==1)
                                            <img src="https://db.expand.ps/images/rep.png"
                                                 onclick="$('#AppModal1').modal('show');$('#repName').html($('#subscriber_name').val());"
                                                 class="hidemob"
                                                 style="cursor:pointer;float:left;margin-top:5px;width:32px;height:32px;margin-left: 20px;">
                                        @endif
                                    </span>
                                            ...
                                            <div class="form-group col-md-12 tablescroll">
                                                <table class="detailsTB table" style="margin-left: 15px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="hidemob col-md-2"
                                                            style="text-align: -webkit-center;color: white;">
                                                            {{ 'رقم الوصل' }}
                                                        </th>
                                    ...
                                    <div class="row attachs-body" style="margin-left: 25px; margin-right: 25px;">
                                        <div class="form-group col-12 mb-2">
                                            <div class="row hidemob">
                                                ...
                                                <div class="col-sm-2"
                                                     style="text-align: center;font-size: 16pt !important;">
                                                    دينار
                                                </div>
                                                <div class="col-sm-2"
                                                     style="text-align: center;font-size: 16pt !important;">
                                            ...
                                            <ol class="vasType 1vas addRec ">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group" style="margin-bottom: 0px;">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" readonly id="ampereCount"
                                                                               name="ampereCount" class="form-control"
                                                                               value="{{$ticket->NewAmpere}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group" style="margin-bottom: 0px;">
                                                                    <div class="input-group"
                                                                        ...
                                                                        <div class="input-group-prepend">
                                                                        <span class="input-group-text vasTitle"
                                                                              id="basic-addon1">
                                                                        ...
                                                                        <input type="text" name="ampereCost"
                                                                               id="ampereCost"
                                                                               class="form-control feesText"
                                                                               value="{{$ticket->ampere_cost}}"
                                                                               onblur="calcAmpereCost()">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-3" style="margin-bottom: 0px;">
                                                                <input type="number" readonly name="ampereTotalCost"
                                                                       id="ampereTotalCost"
                                                                       class="form-control FessVals"
                                                ...
                                                @foreach($arr as $fee)
                                                    ...
                                                    <li style="font-size: 17px !important;color:#000000">
                                                        <div class="row">
                                                            <div class="col-sm-8">
                                                                <input type="text"
                                                                       {{ $readonly?"readonly":"" }} name="feesText[]"
                                                                       class="form-control feesText"
                                                                       value="{{ $fee->feesText}}">
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <input type="number"
                                                                       {{ $readonly?"readonly":"" }} name="feesValue[]"
                                                                       class="form-control FessVals"
                                                                       value="{{ $fee->feesValue*1}}"
                                                                       onblur="calcTotal();addExtraRow();"
                                                                       onchange="calcTotal()">
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <input type="number"
                                                                       {{ $readonly?"readonly":"" }} name="feesValue2[]"
                                                                       class="form-control FessVals2"
                                                                       value="{{ ($fee->feesValue2)*1}}"
                                                                       onblur="calcTotal();addExtraRow();"
                                                                       onchange="calcTotal()">
                                                            </div>
                                                        </div>
                                                ...
                                                @if(!$readonly)
                                                    <li style="font-size: 17px !important;color:#000000">
                                                        <div class="row">
                                                            <div class="col-sm-8">
                                                                <input type="text" name="feesText[]"
                                                                       class="form-control feesText"
                                                                       value="">
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <input type="number" name="feesValue[]"
                                                                       class="form-control FessVals" value="0"
                                                                       onblur="calcTotal();addExtraRow();"
                                                                       onchange="calcTotal()">
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <input type="number" name="feesValue2[]"
                                                                       class="form-control FessVals2" value="0"
                                                                       onblur="calcTotal();addExtraRow();"
                                                                       onchange="calcTotal()">
                                                            </div>
                                                        </div>
                                            ...
                                            <ol class="vasType 1vas olmob" style="list-style-type: none;">
                                                <li style="font-size: 17px !important;color:#000000">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <input type="number" id="total" disabled="" name="total"
                                                                   class="form-control" value="{{$total}}">
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <input type="number" id="total2" disabled="" name="total2"
                                                                   class="form-control" value="{{$total2}}">
                                                        </div>
                                                    </div>
                                                </li>
                                            </ol>
                                                    ...
                                                    <li style="font-size: 17px !important;color:#000000">
                                                        <div class="row">
                                                            <div class="col-sm-5 attmob">
                                                                <input type="text" reuired="" id="attachName[]"
                                                                       name="attachName[]"
                                                                       class="form-control attachName"
                                                                       value="{{$file->attachName}}">
                                                            </div>
                                                            <div class="attdocmob col-sm-5 attach_row_{{$i}}">
                                                                <div id="attach" class=" col-sm-12 ">
                                                                    <div class="attach">
                                                                        <a class="attach-close1" href="{{($url)}}"
                                                                           style="color: #74798D; float:left;"
                                                                           target="_blank">
                                                                            ...
                                                                            @if($file->Files[0]->extension=="jpg"||$file->Files[0]->extension=="png")
                                                                                <img style="width: 20px;"
                                                                                     src="https://t.palexpand.ps/public/assets/images/ico/image.png">
                                                                            @elseif($file->Files[0]->extension=="pdf")
                                                                                <img style="width: 20px;"
                                                                                     src="https://t.palexpand.ps/public/assets/images/ico/pdf.png">
                                                                            ...
                                                                            @else
                                                                                <img style="width: 20px;"
                                                                                     src="https://t.palexpand.ps/public/assets/images/ico/file.png">
                                                                            @endif
                                                                        </a>
                                                                        <input type="hidden" id="attach_ids[]"
                                                                               name="attach_ids[]"
                                                                               value="{{$file->attach_ids}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @if(!$readonly)
                                                                <div class="col-sm-1 attdelmob">
                                                                    <i class="fa fa-trash" id="plusElement1"
                                                                       ...
                                                                       onclick="$(this).parent().parent().parent().remove()"></i>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li style="font-size: 17px !important;color:#000000">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2 attdelmob">
                                                                ...
                                                                <i class="fa fa-trash" id="plusElement1"
                                                                   style="padding-top:10px;position: relative;left: 3%;cursor: pointer;  color:#1E9FF2;font-size: 15pt; "
                                                                   onclick="$('.attach_row_{{$i}}').children().remove();"></i>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
                    ...
                    <div class="card">
                                    ...
                                    <div class="col-md-12" style="text-align: left;">
                                        ...
                                        @if($config[0]->ticket_no == 31)
                                            <a style="padding: .5rem 1rem;"
                                               href="{{url('ar/admin/printTicket31/'.$ticket->id.'/'.$ticket->history[0]->related)}}"
                                        ...
                                        @if($config[0]->ticket_no == 39)
                                            <a style="padding: .5rem 1rem;"
                                               href="{{url('ar/admin/printTicket39/'.$ticket->id.'/'.$ticket->history[0]->related)}}"
                                               class="btn btn-info" target="_blank">
                                                تحرير وطباعة الطلب
                                            </a>
                                        @endif
                                        @if($config[0]->ticket_no == 45)
                                            <a style="padding: .5rem 1rem;"
                                               href="{{url('ar/admin/print45/'.$ticket->id)}}" class="btn btn-info"
                                               target="_blank">
                                                طباعة التقرير
                                            </a>
                                        @endif
                                        @if($config[0]->ticket_no==3)
                                            <a style="padding: .5rem 1rem;"
                                               href="{{url('ar/admin/printTicket3/'.$ticket->id)}}" class="btn btn-info"
                                               target="_blank">
                                                تحرير وطباعة الطلب
                                            </a>
                                            <a style="padding: .5rem 1rem;"
                                               href="{{url('ar/admin/objectionPrint/'.$ticket->id.'/'.$ticket->history[0]->related)}}"
                                               class="btn btn-info" target="_blank">
                                                طباعة عدم ممانعة
                                            </a>
                                        @endif
                                        @if($config[0]->ticket_no == 18)
                                            <a style="padding: .5rem 1rem;"
                                               href="{{url('ar/admin/addLicense/'.$ticket->id.'/'.$ticket->history[0]->related)}}"
                                               class="btn btn-info" target="_blank">
                                                ادخال رخصة البناء
                                            </a>
                                        @endif
                                        ...
                                        @if($config[0]->ticket_no<=17)
                                            <a onclick="ShowComponentModal('formData')">
                                                <img src="https://t.expand.ps/expand_repov1/public/assets/images/ico/spareParts.png"
                                                     style="height: 45px;">
                                            </a>
                                        @endif
                                        <a class="hidemob"
                                           href="{{url('ar/admin/printTicket/'.$ticket->id.'/'.$ticket->history[0]->related)}}"
                                           target="_blank">
                                            <img src="https://template.expand.ps/images/printer.jpeg"
                                                 style="height: 32px;">
                                        </a>
                                        <a class="hidemob" onclick="ShowSMSModal('smsModal')">
                                            <img src="https://template.expand.ps/images/mob32.png">
                                        </a>
                                        <a class="hidemob" style="display:none"
                                           onclick="$('.frmContent').html($('#citizenFormData'));$('#citizenModal').modal('show');$('#citizenFormData').show();">
                                    ...
                                    <div class="card-body">
                                            ...
                                            @foreach($arr as $file)
                                                @if(sizeof($file->Files)>0)
                                                    ...
                                                    <div class="col-sm-4 attach_row11_{{$i}}">
                                                        <div id="attach" class=" col-sm-12 ">
                                                            <div class="attach">
                                                                <a class="attach-close1" href="{{$url1}}"
                                                                   style="color: #74798D; float:left;"
                                                                   target="_blank">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12">
                                                <h5 class="col-md atta chs-section"
                                                    style="text-align: center;color:#385898;font-weight: 600;">
                        ...
                        @if($ticket->ticket_status<>5003)
                            @if($lastReciver==Auth()->user()->id || (in_array(Auth()->user()->id,$tagArr) && $config[0]->can_reply==1) || in_array(Auth()->user()->id,$emp_to_revoke_json))
                                <form onsubmit="return false" id="formData" class="frm1" method="post"
                                      style=" margin-left: 15px; margin-right: 15px;">
                                    <div class="form-control"
                                         style="background-color: #ffffff; margin-bottom:20px; border:0px solid #000000 !important">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-2 imgAvatar" style="text-align: center;">
                                                <span class="avatar" style="width: 60px;">
                                                    <img src="{{Auth()->user()->image}}"
                                                         style="max-height: 60px;border: 1px solid #c7c7c7;padding: 2px;">
                                                    <input name="trans_id" type="hidden"
                                                           value="{{$ticket->active_trans  }}">
                                                    <input name="ticket_id" type="hidden" value="{{$ticket->id  }}">
                                                    <input name="app_type" type="hidden"
                                                           value="{{$ticket->ticket_type  }}">

                                                    <input type="hidden" name="tiketName" id="tiketName"
                                                           value="{{ $config[0]->ticket_name }}">
                                                    <input type="hidden" name="tiketAppNo" id="tiketAppNo"
                                                           value="({{ $ticket->app_no }})">
                                                    <input type="hidden" name="tiketrelated" id="tiketrelated"
                                                           value="{{ $config[0]->ticket_no }}">
                                                    <input type="hidden" name="subscriberName1" id="subscriberName1"
                                                           value="{{ $ticket->customer_name }}">
                                                    <input type="hidden" name="subscriberId1" id="subscriberId1"
                                            ...
                                            <div class="col-sm-12 col-md-10 marginrightminus15 infoAvatar">
                                                        ...
                                                        <div class="form-group status">
                                                            <div class="input-group">
                                                                @if($lastReciver==Auth()->user()->id)
                                                                    ...
                                                                    <select type="text" id="app_status"
                                                                            name="app_status"
                                                                            class="app_status form-control"
                                                                            onchange="$('#app_status1').val($(this).val())">
                                                                        <option value="5002" {{ $ticket->ticket_status == 5002 ? 'selected':'' }}>
                                                                            تغيير حالة الطلب
                                                                        </option>
                                                                        @foreach ($helpers['appStatus'] as $row)
                                                                            <option value="{{$row->id}}" {{ $ticket->ticket_status == $row->id ? 'selected':'' }}> {{$row->name}} </option>
                                                                        @endforeach
                                                                        <option value="6283" {{ $ticket->ticket_status == 6283 ? 'selected':'' }}>
                                                                            مؤجلة
                                                                        </option>
                                                                    </select>
                                                                    <div class="input-group-append ">
                                                                    <span class="input-group-text input-group-text2 hidemob"
                                                                          onclick="ShowConstantModal(5001,'app_status','حالة الطلب')">
                                                                        <i class="fa fa-external-link"></i>
                                                                    </span>

                                                                        <img src="https://db.expand.ps/images/upload.png"
                                                                             height="35"
                                                                             onclick="$('.repAttach').toggle();$('.repAttach1').toggle()">
                                                                    </div>
                                                                @else
                                                                    <img src="https://db.expand.ps/images/upload.png"
                                                                         style="margin-right: auto;" height="35"
                                                                         onclick="$('.repAttach').toggle();$('.repAttach1').toggle()">
                                                                @endif
                                                                {{--<input type="hidden" id="app_status1" name="app_status1" value="5002">--}}
                                                                <input type="hidden" id="app_status1" name="app_status1"
                                                ...
                                                <div class="row">
                                                    <textarea type="text" id="details" name="details"
                                                              class="form-control" placeholder="أدخل ما تم عمله هنا"
                                                              rows="3" aria-invalid="false"
                                                              style="border: none!important;box-shadow: none; text-align: right;"></textarea>
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-md-3" style="color:#000000; width:33%;">
                                                            <img src="https://doc.expand.ps/uploads/s1.jpg?>"
                                                                 id="makeResponse" height="32px" style="cursor: pointer"
                                                        ...
                                                        @if(in_array(Auth()->user()->id,$tagArr))
                                                            <div class="col-md-3 hide"
                                                                 style="color:#000000; width:33%;">
                                                                <img src="https://doc.expand.ps/uploads/s3.jpg?>"
                                                                     id="removeTagBtn" height="32px"
                                                                     style="cursor: pointer"
                                                                     onclick="$('#removeTag').val(true);addAction(this);">
                                                                <br>
                                                                انهاء من طرفي
                                                        ...
                                                        @if($lastReciver==Auth()->user()->id|| in_array(Auth()->user()->id,$emp_to_revoke_json))
                                                            <div class="col-md-3" style="color:#000000; width:33%;">
                                                                <img src="https://doc.expand.ps/uploads/s4.jpg"
                                                                     height="32px"
                                                                     onclick="$('#forwordTo').toggle();$('html, body').animate({scrollTop:$(document).height()}, 'slow');">
                                                                <br>
                                                            ...
                                                            @if(in_array(Auth()->user()->id,$emp_to_close_json))
                                                                @if($lastTicket->related!=32)
                                                                    <div class="col-md-3"
                                                                        ...
                                                                        <img src="https://doc.expand.ps/uploads/s3.jpg"
                                                                             height="32px"
                                                                             onclick="$('#app_status1').val(5003);CloseApp(this)">
                                                                        <br>
                                                                ...
                                                                @else
                                                                    <div class="col-md-3" style="color:#000000;">
                                                                        ...
                                                                        <img src="https://doc.expand.ps/uploads/s3.jpg"
                                                                             height="32px"
                                                                             onclick="closeVac(<?php echo $lastTicket->ticket_id?>,<?php echo $lastTicket->related ?>,1);">
                                                                        <br>
                                                                        موافقة واغلاق
                                                                    </div>
                                                                    <div class="col-md-2" style="color:#000000;">
                                                                        <input type="hidden" name="dept" value="8">
                                                                        <img src="https://template.expand.ps/app-assets/images/rejectClose.jpg"
                                                                             height="40px"
                                                                             onclick="closeVac(<?php echo $lastTicket->ticket_id?>,<?php echo $lastTicket->related ?>,0);">
                                                                        <br>
                                                                        رفض واغلاق
                                                                    </div>
                                                                @endif
                                ...
                                <form onsubmit="return false" class="form frm2" method="post" id="forwordTo"
                                                    ...
                                                    <select type="text" id="AssDeptID" name="AssDeptID"
                                                        ...
                                                        @foreach ($helpers['department'] as $dept)
                                                            <option value="{{$dept->id}}"
                                                                    {{($flows!=null && $nextFlow->nextDeptId==$dept->id)?"selected":''}}
                                                        ...
                                                        @foreach ($employees as $emp)
                                                            <option class="allDept  dept{{$emp->department_id}}
                                                                ...
                                                                @endif"
                                                                    ...
                                                                    value="{{$emp->id}}"
                                                                    dept="{{$emp->department_id}}">{{$emp->nick_name}}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="row" style="    text-align: center;">
                                        ...
                                        <div class="form-group col-md-2 mb-2">
                                            <div class="col-12">
                                                <span id="tag_pic" title="Tag Employee"
                                                      style="margin: 3px; color:#1e9ff2;position:absolute!important;right: 21px!important;">
                                                    <a onclick="$('#tag_id').toggle()">
                                                        <i class="fa fa-user-plus fa-2x"></i>
                                                    </a>
                                                </span>
                                                ...
                                                <h5>
                                                    @if($numberOf_ticket<=1)
                                                        <a class="btn btn-primary hide"
                                                           onclick="deleteTicket(<?php echo $lastTicket->ticket_id?>,<?php echo $lastTicket->related ?>);">حذف
                                                            الطلب </a>
                                                    @endif
                                        ...
                                        <div class="col-sm-12 col-md-10 marginrightminus15 infoAvatar">
                                            ...
                                            <div class="row">
                                                <textarea type="text" id="details" name="details" class="form-control"
                                                          placeholder="سيتم إعادة فتح التكت بناء على النص هنا" rows="3"
                                                          aria-invalid="false"
                                                          style="border: none!important;box-shadow: none; text-align: right;"></textarea>
                                        ...
                                        <div class="form-group col-md-12 mb-2">
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3" style="color:#000000; width:33%;">
                                                        <img src="https://doc.expand.ps/uploads/s4.jpg" height="32px"
                                                             onclick="$('#forwordTo').show();$('html, body').animate({scrollTop:$(document).height()}, 'slow');">
                                                        <br>
                                                        <span class="sendRmob">تحويل إلى موظف</span>
                                                    </div>
                                                    <div class="col-md-4" style="color:#000000; width:33%;">
                                                        <input type="hidden" name="dept" value="8">
                                                        <img src="https://doc.expand.ps/uploads/s3.jpg" height="32px"
                                                             onclick="$('#app_status1').val(5003);CloseApp(this)">
                                                        <br>
                                                        <span class="closeRmob">إغلاق الطلب بشكل نهائي</span>
                                                    </div>
                            ...
                            <form onsubmit="return false" class="form frm2" method="post" id="forwordTo"
                                ...
                                <div class="row" style="margin-top: -10px;">
                                    ...
                                    <div class="form-group col-md-12" style="text-align:center">
                                        ...
                                        <span title="Recive Notification" class="hideMob"
                                              style="margin: 3px;color:#1e9ff2"
                                              onclick="ChangeState($(this))">
                                                    <input type="hidden" id="hasNotify" name="hasNotify" value="0">
                                                    <i class="fa fa-bell fa-2x"></i>
                                                </span>
    ...
    <div class="modal fade text-left" id="ticketSMSModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
         aria-hidden="true">
              ...
              if (data.app_type == 1) {
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    $('.loader').hide()
                    setTimeout(function () {
                      self.location = '{{asset('/ar/admin')}}' + '/addSubscription' + '/' + data.app_id + '/' + data.app_type
                    }, 1500)
