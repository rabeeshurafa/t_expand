...
<div class="row">
    <div class="col-md-7" >
        <div class="form-group paddmob">
            ...
            <input type="text" id="date_buy" {{ $readonly?"readonly":"" }} name="date_buy" data-mask="00/00/0000" maxlength="10" class="form-control" value="{{ $ticket->date_buy }}" placeholder="" autocomplete="off">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-md-7">
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <input {{ $readonly?"readonly":"" }} type="text" id="subscriber_name"
                    class="form-control" placeholder="{{ 'المورد' }}"
