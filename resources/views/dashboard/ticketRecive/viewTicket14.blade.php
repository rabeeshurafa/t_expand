        ...
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <select id="task_type" {{ $readonly?"readonly":"" }} name="task_type"
                    class="form-control">
                    <option value="1" {{ $ticket->task_type==1?'selected':"" }}> تركيب وحدات انارة </option>
                    <option value="2" {{ $ticket->task_type==2?'selected':"" }}> اصلاح وحدات انارة  </option>
                    @foreach($helpers['fixTypeList'] as $sub)
