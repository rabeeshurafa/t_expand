    ...
    <div class="col-md-6">
        <div class="form-group paddmob">
            <div class="input-group ">
                ...
                <input type="text" id="kwatt" class="form-control" {{ $readonly?"readonly":"" }} required="" value="{{ $ticket->kwatt }}" placeholder="" name="kwatt" style="height: 35px;">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group paddmob">
            <div class="input-group ">
                ...
                <input type="text" id="placement" class="form-control" {{ $readonly?"readonly":"" }} required="" value="{{ $ticket->placement }}" placeholder="" name="placement" style="height: 35px;">
            </div>
        </div>
    </div> 
</div>
