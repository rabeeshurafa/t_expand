        ...
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <input type="text" id="TransferAmount" name="TransferAmount"
                    ...
                    aria-describedby="basic-addon1" {{ $readonly?"readonly":"" }} value='{{ $ticket->TransferAmount }}'>
            </div>
        </div>
    </div>
</div>
...
@include('dashboard.ticketRecive.subscriber_rec1',['name_subs'=>'نقل ذمة إلى'])
@include('dashboard.ticketRecive.subscription1')
