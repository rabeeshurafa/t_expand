    ...
    <div class="col-md-6" >
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <input {{ $readonly?"readonly":"" }} class="form-control" type="text" id="orginNo" name="orginNo"
                    class="form-control noleft" placeholder="رقم الحوض"
                    aria-describedby="basic-addon1" value="{{ $ticket->orginNo }}">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group paddmob">
            <div class="input-group">
                ...
                <input {{ $readonly?"readonly":"" }} class="form-control" type="text" id="licNo" name="licNo"
                    class="form-control noleft" placeholder="رقم القطعة"
                    aria-describedby="basic-addon1" value="{{ $ticket->licNo }}">
            </div>
        </div>
    </div>
</div>
