...
@section('content')
    ...
    <div class="app-content content appmainmob">
                                                ...
                                                <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                                    <div class="form-group">
                                                        <div class="input-group w-s-87">
                                                            ...
                                                            <input type="text" id="from1" maxlength="10"
                                                                   data-mask="00/00/0000" name="datee"
                                                                   class="form-control singledate "
                                                                   placeholder="dd/mm/yyyy"
                                                                   aria-describedby="basic-addon1" aria-invalid="false"
                                                                   value="<?php echo date('d/m/Y')?>" autocomplete="off"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <div class="input-group width99 width98rtl widthsub" style="">
                                                            ...
                                                            <input type="text" id="formDataNameAM"
                                                                   class="form-control alphaFeild ap ui-autocomplete-input"
                                                                   placeholder="ابدا بالكتابة لعرض محاور البحث"
                                                                   name="formDataNameAR" autocomplete="off">
                                                            <input type="hidden" id="beneficialId" name="beneficialId">
                                                        </div>
                                                        <div id="auto-complete-barcode"
                                                             class="divKayUP barcode-suggestion ">
                                                        </div>
                                                ...
                                                <div class="col-lg-2 col-md-6" style="position: relative; right: 45%">
                                                    <div class="form-group">
                                                        <button type="button" onclick="search()"
                                                                class="btn btn-primary addBtn" id="save">
                                                            {{"بحث"}}
                                                            <i class="ft-search"></i>
                                                        </button>
                                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header" style="direction: rtl;">
                                <h4 class="card-title"><img
                                        src="{{ asset('assets/images/ico/report32.png') }}"/>{{ trans('تقرير الأعمال') }}
                                    <span style="float: left;">
                                        <a style="padding: .5rem 1rem;" class="btn btn-info" onclick="goToPrint()">
                                            طباعة
                                        </a>
                                    </span>
                                </h4>
        ...
        <script>
            ...
            //             {data:'start'},
            //             {data:'end'},
            //             {data:'beneficial_name'},
            //             {data:'state_name.name',name:'state'}
            //         ],
            //         /////////////////////////////////////////////////////////////////////////////////
            //         dom: 'Bflrtip',
            //         buttons: [
            ...
            function goToPrint(){
                ...
                let most = ($("#beneficialId").val() === ''?0 : $("#beneficialId").val());
                let date1 = $("#from").val();
                let date2 = $("#from1").val();
                let state = ($("#state").val() === ''?0 : $("#state").val());
                date1=date1.split('/');
                date2=date2.split('/');
                date1=date1[2]+'-'+date1[1]+'-'+date1[0]
                date2=date2[2]+'-'+date2[1]+'-'+date2[0]
                let url=`{{ route('admin.dashboard') }}/printdailywork/${date1}/${date2}/${empId??0}/${most??0}/${state??0}`
                // console.log(url)
