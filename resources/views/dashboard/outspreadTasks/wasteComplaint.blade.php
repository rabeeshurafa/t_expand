                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="">
                                                    ...
                                                    <select id="task_type" name="task_type" type="text"
                                                        ...
                                                        <option value="" selected=""> {{ 'نوع الشكوى' }} </option>
                                                    ...
                                                    <div class="input-group-append"onclick="ShowConstantModal(6405,'task_type','نوع الشكوى')">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="">
                                                    ...
                                                    <textarea type="text" id="malDesc" class="form-control"
                                                        placeholder="وصف الشكوى" name="malDesc"
