                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select id="type" name="type" type="text"
                                                            class="form-control valid type" aria-invalid="false">
                                                        <option value="6114"> {{ 'بدون' }} </option>
                                                        @foreach($complaintTypes as $complaintType)
                                                            <option value="{{ $complaintType->id }}">{{ $complaintType->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-group-append"
                                                         onclick="ShowConstantModal(6113,'type','نوع الشكوى')">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="subscriber_name"
                                                           ...
                                                           placeholder="{{ 'اسم المشتكى' }}"
                                                           name="subscriber_name" @if(isset($ticket)) readonly
                                                           value="{{$ticket->customer_name}}"@endif>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="width: 97% !important; ">
                                                    ...
                                                    <input type="text" id="MobileNo" maxlength="10" name="MobileNo"
                                                           ...
                                                           @if(isset($ticket))  value="{{$ticket->customer_mobile}}"@endif>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group paddmob">
                                                    <div class="input-group subscribermob">
                                                        ...
                                                        <input type="text" id="national_id"
                                                               class="form-control numFeild" maxlength="9"
