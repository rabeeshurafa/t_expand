                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="NationalID" maxlength="9"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="MobileNo2" maxlength="10" name="MobileNo2"
                                                           class="form-control noleft numFeild" placeholder="0560000000"
                                                           aria-describedby="basic-addon1"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="InternalPhone" name="InternalPhone"
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <select type="text" id="DepartmentID" name="DepartmentID"
                                                        class="form-control"
                                                        onchange="getDeptInfo($(this).val(),DirectManager)">
                                                    <optionvalue
                                                    ="0"> {{trans('admin.select')}} </option>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <?php $types = $type; ?>
                                                <select id="JobType" name="JobType" type="text"
                                    ...
                                    <div class="col-md-5" style="padding-right: 0">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="HiringDate" name="HiringDate" data-mask="00/00/0000"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input id="vac_year" name="vac_year" maxlength="4"
                                        ...
                                        <div class="col-md-4" style="padding-right: 0px;">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input id="vac_annual" name="vac_annual" maxlength="2"
                                                           class="form-control valid" placeholder="" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4" style="padding-right: 0px;">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input id="emr_blanace" name="emr_blanace" maxlength="2"
                                                           class="form-control valid" placeholder="" value="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="@if(!Auth()->user()->id==74){{'password'}} @endif"
                        ...
                        <div class="card-content collapse show">
                                        ...
                                        <div class="row" style="text-align: center">
                                            <div class="col-md-2 w-s-50" style="padding: 0px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <a onclick="$('#ArchModalName').html($('#Name').val());$('#msgModal').modal('show')"
                            ...
                            <div class="form-actions" style="border-top:0px; padding-bottom:44px;">
                                <div class="text-right">
                                    @can('edit_model')
                                        <button type="submit" style="display:none;" class="btn btn-primary"
                                                id="editBtn">{{trans('admin.modify')}} <i
        ...
        $.ajax({
          ...
          error: function (response) {
            ...
            if (response.responseJSON.errors.Name) {
              $("#Name").addClass("error");
              errorMsg += response.responseJSON.errors.Name[0] + '\n'
            }
            if (response.responseJSON.errors.NationalID) {
              $("#NationalID").addClass("error");
              errorMsg += response.responseJSON.errors.NationalID[0] + '\n'
            }
            ...
            if (response.responseJSON.errors.MobileNo1) {
              ...
              errorMsg += response.responseJSON.errors.MobileNo1[0] + '\n'
            }
            if (response.responseJSON.errors.MobileNo2) {
              $("#MobileNo2").addClass("error");
              errorMsg += response.responseJSON.errors.MobileNo2[0] + '\n'
            }
            alert(errorMsg);
            Swal.fire({
              position: 'top-center',
