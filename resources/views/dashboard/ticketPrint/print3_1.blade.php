...
<form method="post" id="rpFrm" dir="rtl" style="min-height:950px;padding-top: 10px;padding-left: 47px; padding-right: 47px;">
        ...
        @if($config[0]->ticket_no==3 && $config[0]->app_type==1)
        <div class="row">
            <div class="form">
            </div><table class="table table-bordered mb-3 st" style="text-align:center">
                <thead>
                    <tr><th> أ </th>
                    <th> ب </th>
                    <th> ج </th>
            ...
            <div class="col-md-12 pr-s-12">
                <div class="form-group">
                    <div class="input-group w-s-87 mt-s-6">
                        ...
                        <input type="text" id="note_s" value="{{$ticket->note_s}}" required="" class="form-control" placeholder=" الملاحظات  " name="note_s">
        ...
        <div class="row">
            <div class="col-md-6 pr-s-12" dir="ltr" style="text-align: right;">
                       : السيد مدير عام شركة توزيع كهرباء الشمال المحترم
                </div>
        </div>
        <div class="row">
            <div class="col-md-6 pr-s-12" style="text-align: right;">
                بموجب المعلومات أعلاه يوافق على طلب تزويد اشتراك 
                <b> {{$ticket->subscriptionType->name}} </b>
                للمستدعي :
