                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87">
                                                    ...
                                                    <select name="arcType" id="OrgType" class="form-control"
                                                        ...
                                                        <option value="contractArchive">{{trans('archive.dep_archive')}}</option>
                                                        <option value="citArchive">{{trans('archive.cit_archive')}}</option>
                                                        <option value="assetsArchive">{{trans('archive.assets_archive')}}</option>
                                        ...
                                        <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                            <div class="form-group">
                                                <div class="input-group w-s-87">
                                                    ...
                                                    <input type="text" id="toDate" name="toDate" data-mask="00/00/0000"
                                                           maxlength="10" class="form-control eng-sm  valid"
                                                           value="<?php echo date('d/m/Y')?>" onblur="calcDuration()"
