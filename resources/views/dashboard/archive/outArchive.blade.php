                                            ...
                                            <div class="form-group paddmob">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    @if($type=='outArchive')
                                                        ...
                                                        <input type="hidden" id="archive_type" name="archive_type"
                                                               value="1">
                                                    ...
                                                    @if($type=='projArchive'||$type=='munArchive'||$type=='empArchive'||$type=='contractArchive'||$type=='assetsArchive'||$type=='citArchive')
                                                        ...
                                                        <input type="text" id="msgTitle"
                                                               class="form-control removeborders" name="msgTitle"
                                                               style="width: 30%;">
                                                        ...
                                                        @if($type=='munArchive')
                                                            ...
                                                            <div class="input-group-append hidemob"
                                                                 onclick="ShowConstantModal(49,'archive_type','{{ trans('archive.document_type') }}')"
                                                        ...
                                                        @elseif($type=='empArchive')
                                                            ...
                                                            <div class="input-group-append hidemob"
                                                                 onclick="ShowConstantModal(50,'archive_type','{{ trans('archive.document_type') }}')"
                                                                 style="cursor:pointer">
                                                        ...
                                                        @elseif($type=='contractArchive')
                                                            ...
                                                            <div class="input-group-append hidemob"
                                                                 onclick="ShowConstantModal(51,'archive_type','{{ trans('archive.document_type') }}')"
                                                                 style="cursor:pointer">
                                                        ...
                                                        @elseif($type=='citArchive')
                                                            ...
                                                            <div class="input-group-append hidemob"
                                                                 onclick="ShowConstantModal(52,'archive_type','{{ trans('archive.document_type') }}')"
                                                                 style="cursor:pointer">
                                                        ...
                                                        @elseif($type=='projArchive')
                                                            ...
                                                            <div class="input-group-append hidemob"
                                                                 onclick="ShowConstantModal(53,'archive_type','{{ trans('archive.document_type') }}')"
                                                                 style="cursor:pointer">
