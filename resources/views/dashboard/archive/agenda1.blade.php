                                                    ...
                                                    <div class="input-group w-s-87">
                                                        ...
                                                        <select type="text" id="meetingTitleName" name="meetingTitleName"
                                                            ...
                                                            @if(count($agendaExtention)>0)
                                                                ...
                                                                {{-- @if(Auth()->user()->id==74 || in_array(Auth()->user()->id,is_array( json_decode($agenda->employee)))?json_decode($agenda->employee):array()) --}}
                            ...
                            <table style="width:100%;direction: rtl;text-align: right;background-color: #ffffff;"
                                ...
                                <tbody id="recList">
                                    <tr class="card123">
                                        ...
                                        <td scope="col">
                                            <textarea class="form-control" placeholder="{{trans('archive.enter_subject_here')}}"
...
@section('script')
    ...
    function DisplayMeeting(){
        ...
        row='<tr class="card'+id+' card123">'
            ...
            +'    <td scope="col">'
            +'        <textarea class="form-control" placeholder="" id="topicTitle'+id+'" name="topicTitle'+id+'" style=" text-align: right;" onchange="DrawBorder('+id+')">'+data.agenda_topic[i].title+'</textarea>'
            ...
            +'    </td>'
            +'    <td scope="col">'
            +'        <textarea type="text" class="form-control" onchange="DrawBorder('+id+')" rows="2" id="descisiontxt'+id+'" name="descisiontxt'+id+'">'+data.agenda_topic[i].descision+'</textarea>'
            ...
            +'                    <img src="https://h.expand.ps/expand_repov1/public/assets/images/ico/floppy-icon.png" style="height: 32px;">'
            +'               </button>'
            ...
            +'                    <img src="https://h.expand.ps/expand_repov1/public/assets/images/ico/upload.png" style="height: 32px;">'
            +'               </a>'
    ...
    function endMeeting(){
        ...
        function addTopicTemplate(){
            ...
            +'                    </td>'
            +'                    <td scope="col">'
            +'                        <textarea class="form-control" onchange="DrawBorder('+itopic+')" placeholder="{{trans('archive.enter_subject_here')}}" id="topicTitle'+itopic+'" name="topicTitle'+itopic+'" style="text-align: right;"></textarea>'
            ...
            +'                    </td>'
            +'                    <td scope="col">'
            +'<textarea  type="text" class="form-control" placeholder="{{trans('archive.enter_subject')}}" onchange="DrawBorder('+itopic+')" rows="2" id="descisiontxt'+itopic+'" name="descisiontxt'+itopic+'"></textarea>'
            +'                        '
            ...
            +'                                <span id="attach-required">*</span>'
            +'                                <span class="attach-icons" style="margin-left: 0px;">'
            +' <button type="button" class="mainbutton" name="mainbutton" id="mainbutton" style="border:0px; background:#ffffff; " onclick="if (saveMeeting()){addTopicTemplate();$(this).hide()}">'
