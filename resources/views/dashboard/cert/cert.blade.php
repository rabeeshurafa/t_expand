...
@section('content')
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-12">
                        <div class="card leftSide">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <img src="https://template.expand.ps/images/personal-information.png" width="32"
                                         height="32">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-12 " style="padding-left: 0px;">
                                                <div class="input-group">
                                                    ...
                                                    <input required type="text" id="cer_date" data-mask="00/00/0000"
                                                           maxlength="10" class="form-control"
                                                           onblur="$('.cer_date').html($(this).val());" name="cer_date"
                                                           value="<?php  echo date('d/m/Y'); ?>"
                                                           style="color:darkslategrey; border-color: slategray;">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-12 pr-s-12">
                                                <div class="form-group">
                                                    <div class="input-group w-s-87 mt-s-6">
                                                        ...
                                                        <input type="text" id="certYear" class="form-control"
                                                               onblur="$('.serial_no').html(($(serial_per_year).val()+'/'+ $(this).val()));"
                                                               name="certYear" value="<?php  echo date('Y'); ?>"
                                                               style="color:darkslategrey; border-color: slategray;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12 pr-s-12"
                                                 style="padding-left: 49px;padding-right: 0px;">
                                                <div class="form-group">
                                                    <div class="input-group w-s-87 mt-s-6">
                                                        <div class="input-group-prepend">
                                                                <span class="input-group-text" id="basic-addon1">
                                                        ...
                                                        <input type="text" id="serial_per_year" class="form-control"
                                                               name="serial_per_year" value="{{$CertCount}}"
                                                               onblur="$('#certCnt').html($(this).val());$('.serial_no').html(($(this).val()+'/'+ $('#certYear').val()));"
                                                               style="color:darkslategrey; border-color: slategray;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 pr-0 pr-s-12">
                                                <div class="form-group">
                                                    <div class="input-group w-s-87">
                                                        ...
                                                        <input type="text" id="recept_no" class="form-control numFeild"
                                                               placeholder="رقم الوصل" name="recept_no"
                                                               autocomplete="off"
                                                               style="color:darkslategrey; border-color: slategray;  margin-left: 15px;">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 col-md-12 pr-s-12">
                                                <div class="form-group">
                                                    <div class="input-group w-s-87 mt-s-6">
                                                        ...
                                                        <input required type="text" id="citizen_name"
                                                               class="form-control alphaFeild cust"
                                                               placeholder="مقدم الطلب" name="citizen_name"
                                                               style="color:darkslategrey; border-color: slategray"
                                                               aria-required="true" aria-invalid="false">
                                                        <input type="hidden" value="0" id="applicantID"
                                                               name="applicantID" class="form-control ccac alphaFeild">
                                                        <input type="hidden" id="model" name="model"
                                                               value="App\Models\User">
                                                        <input type="hidden" value="0" id="cer_pk_id"
                                                               class="form-control" placeholder="" name="cer_pk_id">
                                                        <input type="hidden" value="{{$e_type}}" id="e_type"
                                                               class="form-control" placeholder="" name="e_type">
                                                        <input type="hidden" id="app_type" name="app_type" value="1">
                                                        <input type="hidden" id="app_no" name="app_no"
                                                               value="<?php /* echo $res[0]->cnt*/ ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input required type="text" id="NationalID" maxlength="9"
                                                           minlength="9" class="form-control" placeholder="رقم الهوية"
                                                           name="NationalID"
                                                           onkeyup="$('.citizenID').html($('#NationalID').val())"
                                                           style="color:darkslategrey; border-color: slategray"
                                                           aria-required="true" aria-invalid="false">

                                                    <div class="input-group-append hide"
                                                         onclick="QuickAdd(17,'PositionID','Position')">
                                ...
                                <div class="card-body" style="padding-top: 0px;">
                                        ...
                                        <div class="col-lg-6 col-md-12 pr-s-12" style="">
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <select type="text" id="msgTitle"
                                                            class="form-control selectFullCorner"
                                                            onchange="copytxt($(this).val())" name="msgTitle"
                                                            style="color:darkslategrey; border-color: slategray">
                                                        <option value="0" style="font-size: 18px;"> -- الشهادة --
                                                        </option>
                                                        @foreach($CertExtention as $cert)
                                                            <option id="certID"
                                                                    value="{{$cert->pk_i_id}}">{{$cert->s_name_ar}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-group-append" onclick="AddNew('msgTitle','شهادة')"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text" id="cost" class="form-control"
                                                           placeholder="أدخل المبلغ" name="cost">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group ">
                                                    ...
                                                    <input class="form-check-input" type="checkbox"
                                                           onclick="$('#msg_title').toggle()" value="" id="show_title">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <input type="text" id="benefitS" name="benefitS"
                                                           ...
                                                           onkeyup="$('#benefitside').html($('#benefitS').val())"
                                                           aria-describedby="basic-addon1"
                                                           style="color:darkslategrey; border-color: slategray"
                                                           value="لمن يهمه الأمر">

                                                    <input type="hidden" id="benefitside_cd" name="benefitside_cd"
                                                           value="0">
                                                    <input type="hidden" id="benefitside_lbl" name="benefitside_lbl"
                                                           value="0">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-12">
                                            ...
                                            <input type="radio" name="phase[]" checked="" id="radio-1"
                                                   class="jui-radio-buttons" value="1" onclick="setbenefitStyle(1);">
                                            <label for="radio-2" style="padding-right:10px">
                                                يمين
                                            </label>
                                            <input type="radio" name="phase[]" id="radio-2" class="jui-radio-buttons"
                                                   value="2" onclick="setbenefitStyle(2);">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 pr-s-12" style="">
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6" style="width: 98% !important;">
                                                    ...
                                                    <textarea id="summary-ckeditor" name="summary-ckeditor"
                                                              class="form-control"
                                                              onchange="$('#msg_content').html($('#msgContent').val())"
                                                              onkeyup="$('#msg_content').html($('#msgContent').val())"
                                                              style="color:darkslategrey; border-color: slategray; font-size: 14pt;"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div id="forPrint">
                                        <table width="100%" style="color: black;direction:rtl; padding-bottom:150px;">
                                            <tr style="background-color: #FFFFFF;">
                                                <td colspan="3">
                                                    <img src="{{$setting->header_img}}" width="100%"
                                                         style="max-width:100%">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="3" align="center" style="padding-top:50px !important">
                                                    <h2 id="benefitside" class="benefitside"
                                                        style="font-family: Helvetica,Arial, sans-serif !important; font-weight:bold ">
                                                        لمن يهمه الأمر
                                            ...
                                            <tr>
                                                <td colspan="3" align="center">
                                                    <u>
                                                        <h2 id="msg_title"
                                                            style="font-family: Helvetica,Arial, sans-serif !important; font-weight:bold;display:none">
                                            ...
                                            <tr>
                                                <td colspan="3" style="direction: rtl; line-height:1.5" id="fullBody">
                                                        <span id="msg_content"
                                                              style="font-family: Arial, sans-serif !important; font-size: 18px !important; font-weight: 500;">
                                    ...
                                    <div class="form-actions" style="border-top:0px;">
                                        <div class="text-right">
                                            <button class="btn btn-primary" id="saveBtn">حفظ وطباعة <i
                                                        class="fa fa-print"></i></button>
                                            @if(Auth()->user()->id)
                                                <a class="btn btn-primary" style="color: #FFF;" onclick="printDiv()">
                                                    معاينة قبل الطباعة <i class="fa fa-print"></i></a>
                                            @endif
                                            <button type="reset" onclick="resetFunction();" class="btn btn-warning">
                                                اعادة تعيين <i class="ft-refresh-cw position-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade text-left" id="AddNew" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
         aria-hidden="true">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="input-group w-s-87">
                                ...
                                <input type="hidden" id="ctrlToRefresh1" class="form-control" placeholder="Label (En)"
                                       name="ctrlToRefresh1">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group w-s-87">
                                ...
                                <input type="text" id="cost_cert" class="form-control" placeholder="أدخل المبلغ"
                                       name="cost_cert">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group w-s-87">
                                ...
                                <input readonly type="text" id="cerText" class="form-control" placeholder=""
                                       name="cerText">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group w-s-87">
                                ...
                                <textarea id="cercontent" class="form-control" placeholder=""
                                          name="cercontent"></textarea>
                            </div>
                        </div>
            ...
            success: function (data) {
              ...
              for (let i = 0; i < data?.all_files?.length; i++) {
                ...
                attach_template += `<li style="font-size: 17px !important;color:#000000">
                            <div class="row">
                                <div class="col-sm-5">
                              <input type="text" required id="attachName${(i + 1)}" key="${(i + 1)}" name="attachName[]" class="form-control attachName" value="${data.all_files[i].attachName}">
                                </div>
                                <div class="col-sm-5 attach_row_${(i + 1)}">
                                    <div id="attach" class=" col-sm-12 ">
                                        <div class="attach"> 
                                            ...
                                            <input type="hidden" id="attach_ids${(i + 1)}" name="attach_ids[]" value="${data.all_files[i].attach_ids}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-1">
              ...
              attach_index = data?.all_files?.length + 1;
              attach_template += `<li style="font-size: 17px !important;color:#000000">
                <div class="row">
                    <div class="col-sm-5">
                        <input type="text" id="attachName${(attach_index)}" key="${(attach_index)}" name="attachName[]" class="form-control attachName" placeholder="أدخل اسم المرفق" value="">
                    </div>
                    ...
                    <div class="col-sm-1">
                        <img src="{{ asset('assets/images/ico/upload.png') }}" width="40"
                            height="40" style="cursor:pointer"
                            onclick="$('#currFile').val(${(attach_index)});validateName(${(attach_index)});">
                    </div>
                </div>
            </li>`
