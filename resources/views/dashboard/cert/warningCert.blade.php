                                        ...
                                        <div class="col-lg-6 col-md-12 pr-s-12" style="">
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <div class="input-group-append" onclick="AddNew('msgTitle','اخطار')"
                                ...
                                <div class="card-body">
                                    <div id="forPrint">
                                        <table width="100%" style="color: black;direction:rtl; padding-bottom:150px;">
                                            ...
                                            <tr>
                                                <td style="text-align:right;direction:rtl;padding-right: 83px !important;">
                                                    التاريخ
                                                    <span class="cer_date">
                                                            <?php echo date('d/m/Y') ?>
                                                        </span>
                                                ...
                                                <td></td>
                                                <td style="text-align:right; direction:ltr;">الرقم :<span
                                                            class="serial_no">{{$CertCount}}</span></td>
                                            </tr>
