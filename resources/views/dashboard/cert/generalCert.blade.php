                ...
                <div class="row white-row">
                    <div class="col-sm-12 col-lg-6 col-md-12">
                        <div class="card leftSide">
                            ...
                            <div class="card-header hide">
                                <h4 class="card-title">تفاصيل المراسلة العامة</h4>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <select type="text" id="msgTitle"
                                                            ...
                                                            style="color:darkslategrey; border-color: slategray">
                                                        <option value="0" style="font-size: 18px;"> -- المراسلة العامة
                                                            --
                                                        </option>
                                                    ...
                                                    <div class="input-group-append"
                                                         onclick="AddNew('msgTitle','المراسلة العامة')"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6" style="width:100% !important">
                                                    ...
                                                    <input type="text" id="benefitS" name="benefitS"
                                                           class="form-control cust" placeholder=" "
                                        ...
                                        <div class="col-lg-5 col-md-12 pr-s-12" style="padding-right: 0">
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <input type="text" id="sentDir" name="sentDir"
                                                           class="form-control cust1" placeholder=" "
                                                           aria-describedby="basic-addon1"
                                                           style="color:darkslategrey; border-color: slategray"
                                                           value="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group ">
                                                    ...
                                                    <input class="form-check-input" type="checkbox"
                                                           onclick="$('#msg_title').toggle()" value="" checked
                                                           id="show_title">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-12">
                        <div class="card rightSide">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">المراسلة العامة
                                ...
                                <div class="card-body">
                                    <div id="forPrint">
                                        <table width="100%" style="color: black;direction:rtl; padding-bottom:150px;">
                                            <tr style="background-color: #FFFFFF;">
                                                <td colspan="3">
                                                    <img src="{{$setting->header_img1}}" width="100%"
                                                         style="max-width:100%">
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align:right; direction:rtl;padding-top: 20px !important;">
                                                    التاريخ
                                                    <span class="cer_date">
                                                            <?php echo date('d/m/Y') ?>
                                                        </span>
                                        ...
                                        <table width="100%" class="footerLine"
                                               style="border:0px solid #ffffff; margin-bottom:20px;">
                                            <tr>
                                                <td style="border:0px solid #ffffff;">
                                                    <img src="{{$setting->footer_img1}}" width="100%">
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="form-actions" style="border-top:0px;">
                                        <div class="text-right">
                                            <button class="btn btn-primary" type="button" id="saveBtn">حفظ وطباعة <i
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                ...
                                                <table style="width:100%; margin-top: -10px;direction: rtl;text-align: right"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>اسم المواطن</th>
                                                        <th>صادر الى</th>
                                                        <th>رقم المراسلة العامة</th>
                                                        <th>عنوان المراسلة العامة</th>
                                                        <th>تاريخ المراسلة العامة</th>
                                                        <th>الموظف</th>
...
@section('script')
    <script>
      function setReadOnly() {
        certId = $("#cer_pk_id").val()
        if (certId != null && certId != '' && certId > 0) {
          document.getElementById("citizen_name").readOnly = true;
        }
      }
      ...
      function resetFunction() {
        ...
        $('#applicantID').val('');
        $('#cer_pk_id').val('');
        document.getElementById("citizen_name").readOnly = false;
        editor.setData("");
        resize();
      }
      ...
      function deleteCer(id) {
        if (confirm('هل انت متاكد من حذف المراسلة العامة')) {
          $.ajaxSetup({
            headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
      ...
      function DrawCertOut() {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $("#" + fillIn).html(new Option(" -- المراسلة العامة -- ", ''));
            if (data.length > 0) {
