                                                ...
                                                <div class="form-group">
                                                    <div class="input-group w-s-87 mt-s-6">
                                                        ...
                                                        <select type="text" id="msgTitle" class="form-control selectFullCorner" onchange="copytxt($(this).val())" name="msgTitle" style="color:darkslategrey; border-color: slategray">
                                                            <option value="0" style="font-size: 18px;"> -- المراسلة العامة --</option>
                                                            @foreach($CertExtention as $cert)
                                                            <option id="certID" value="{{$cert->pk_i_id}}">{{$cert->s_name_ar}}</option>
                                                            @endforeach
                                                        </select>
                                                        <div class="input-group-append" onclick="AddNew('msgTitle','المراسلة العامة')" style="cursor:pointer">
                                            ...
                                            <div class="col-lg-1 col-md-12" style="padding-right: 0;margin-top: 5px">
                                                <div class="form-group">
                                                    <div class="input-group ">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" onclick="$('#msg_title').toggle()" value="" checked id="show_title">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="forPrint">
                                            <table width="100%"  style="color: black;direction:rtl; padding-bottom:150px;">
                                                <tr style="background-color: #FFFFFF;">
                                                    <td colspan="3">
                                                        <img src="{{$setting->header_img1}}" width="100%" style="max-width:100%">
                                                    </td>
                                                </tr>
                                                
                                                <tr>
                                                    <td style="text-align:right; direction:rtl;padding-top: 20px !important;">التاريخ
                                                    <span class="cer_date">
                                                            <?php echo date('d/m/Y')?>
                                                        </span>
                                                    </td>
