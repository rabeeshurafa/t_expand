                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-12 pr-s-12"
                                                 style="margin-right: -10px;margin-left: 10px;padding-left: 26px;">
                                                <div class="form-group">
                                                    <div class="input-group w-s-87 mt-s-6">
                                                        ...
                                                        <input type="text" id="serial_per_year" class="form-control"
                                                               ...
                                                               onblur="$('#certCnt').html($(this).val());$('.serial_no').html($(this).val());"
                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <select type="text" id="msgTitle"
                                                            ...
                                                            style="color:darkslategrey; border-color: slategray">
                                                        <option value="0" style="font-size: 18px;"> -- التعهد --
                                                        </option>
                                                    ...
                                                    <div class="input-group-append" onclick="AddNew('msgTitle','تعهد')"
                                ...
                                <div class="card-body">
                                    <div id="forPrint">
                                        <table width="100%" style="color: black;direction:rtl; padding-bottom:150px;">
                                            ...
                                            {{--<tr>
                                                <td style="text-align:right; direction:rtl;">رقم التعهد:<span class="serial_no">{{$CertCount}}</span></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td style="width: 50%; padding-top: 50px !important;"></td>
                                                <td style="text-align:left; padding-top: 50px !important;">
                                                    الإسم:
                                                </td>
                                                <td style="border-bottom: 1px #000000 dashed; padding-top: 50px !important;"
                                                    id="personName">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="border-bottom: 1px #000000 dashed;" class="cer_date"
                                                    id="date"> <?php echo date('d/m/Y') ?> </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 50%;"></td>
                                                <td style="text-align:left;">
                                                ...
                                                <td style="border-bottom: 1px #000000 dashed;"></td>
                                            </tr>
                                        </table>
        ...
        <div class="modal-dialog modal-dialog2" role="document" style="max-width: 42%!important;">
            <div class="modal-content" style="width: 700px;">
                <div class="modal-header modal-header2">
                    <h4 class="modal-title" id="myModalLabel1" style="color: #ffffff;"><span>تعريف التعهد</span></h4>
...
@section('script')
    <script>
      ...
      function deleteCer(id) {
        if (confirm('هل انت متاكد من حذف التعهد')) {
          $.ajaxSetup({
            headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
