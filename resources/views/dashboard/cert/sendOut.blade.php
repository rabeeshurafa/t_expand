                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <select type="text" id="msgTitle"
                                                            ...
                                                            style="color:darkslategrey; border-color: slategray">
                                                        <option value="0" style="font-size: 18px;"> -- المراسلة --
                                                        </option>
                                                    ...
                                                    <div class="input-group-append"
                                                         onclick="AddNew('msgTitle','المراسلة')" style="cursor:pointer">
                                ...
                                <div class="card-body">
                                    <div id="forPrint">
                                        <table width="100%" style="color: black;direction:rtl; padding-bottom:150px;">
                                            ...
                                            <tr>
                                                <td style="text-align:right; direction:rtl">رقم المراسلة:<span
