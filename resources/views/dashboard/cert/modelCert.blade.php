                    ...
                    <div class="col-sm-12 col-lg-6 col-md-12">
                        <div class="card leftSide">
                            ...
                            <div class="card-header hide">
                                <h4 class="card-title">تفاصيل النموذج</h4>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87 mt-s-6">
                                                    ...
                                                    <select type="text" id="msgTitle"
                                                            ...
                                                            style="color:darkslategrey; border-color: slategray">
                                                        <option value="0" style="font-size: 18px;"> -- نموذج --</option>
                                                        @foreach($CertExtention as $cert)
                                                            <option id="certID"
                                                                    value="{{$cert->pk_i_id}}">{{$cert->s_name_ar}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-group-append" onclick="AddNew('msgTitle','نموذج')"
...
@section('script')
    <script>
      ...
      function deleteCer(id) {
        if (confirm('هل انت متاكد من حذف النموذج')) {
          $.ajaxSetup({
            headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
      ...
      function DrawCertOut() {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $("#" + fillIn).html(new Option(" -- النموذج -- ", ''));
            if (data.length > 0) {
