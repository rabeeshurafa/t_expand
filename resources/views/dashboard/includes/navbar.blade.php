...
?>
<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-dark navbar-without-dd-arrow navbar-shadow hide"
     id="nav_expanded_nav"
            ...
            <li class="dropdown nav-item" data-menu="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    if ($row1->show_in_menu == 1){
                        ?>
                    <li data-menu="">
                        <a class="dropdown-item" href="{{asset("$lang/admin/$row1->s_function_url")}}"
                           data-toggle="dropdown">{{$lang=='en'?$row1->s_function_title_en:$row1->s_function_title}}</a>
                        @if($row[0]->pk_i_id==1&&Auth()->user()->id==74&&!$flag)
                            <a class="dropdown-item" href="{{route("admin.dashboard")}}/permissions"
                               data-toggle="dropdown">نظام الصلاحيات</a>
                                <?php $flag = true ?>
                        @endif
