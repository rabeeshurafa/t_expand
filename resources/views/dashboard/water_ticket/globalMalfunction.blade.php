            ...
            <div class="row white-row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card leftSide">
                                        ...
                                        <div class="col-md-12 pr-s-12">
                                            ...
                                            <div class="form-group" style="padding-left: 4px;">
                                                <div class="input-group">
                                                    <textarea type="text" id="malDesc" class="form-control" placeholder="وصف العطل" name="malDesc" 
                                                    style="width:98% ; border-radius:5px !important;height: 35px;" aria-invalid="false">@if(isset($ticket)){{$ticket->malDesc}}@endif</textarea>
                        ...
                        @include('dashboard.includes.attachment',['ticketInfo'=>$ticketInfo,'department'=>$department])
