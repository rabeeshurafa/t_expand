                            ...
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-body">
                                    ...
                                    <div class="row Acting @if(isset($ticket))
                                        ...
                                        @else
                                        @endif" style="@if(!isset($ticket)) position: relative; display: none; @endif"
                                         id="Acting">
                                        <div class="col-md-7">
                                                ...
                                                @if(isset($ticket))
                                                    ...
                                                    @foreach($ticket->subscription as $subs)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{($subs->licNo??'')}}
                                                                <input type="hidden" name="SubscribtionIdList[]"
                                                                       value="{{$subs->id}}">
                                                                <input type="text"
                                                                       class="form-control form-control1 numFeild hide"
                                                                       name="SubscribtionNumList[]"
                                                                       value="{{($subs->subscription_no??'')}}">
                                                            </td>
                                                            <td class="hidemob" style="text-align: -webkit-center;">
                                                                {{($subs->counter_Type_name??'')}}
                                                                <input type="text"
                                                                       class="form-control form-control1 alphaFeild hide"
                                                                       name="CounterTypeList[]"
                                                                       value="{{($subs->counter_Type_name??'')}}">
                                                            </td>
                                                            <td style="text-align: -webkit-center;">
                                                                {{($subs->placeDesc??'')}}
                                                                <input type="text"
                                                                       class="form-control form-control1   hide"
                                                                       name="CapacityList[]"
                                                                       value="{{($subs->placeDesc??'')}}">
                                                            </td>
        ...
        $.ajax({
          ...
          success: (response) => {
            if (response) {
              ...
              if (response.warning.length != 0 && response.water.length != 0 && response.errorList.length == 0) {
                $(".btnArea").addClass("hide");
                warningText = '  المواطن لديه اخطار';
                for (i = 0; i < response.warning.length; i++) {
                  warningOpj = response.warning[i];
