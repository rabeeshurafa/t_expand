                    ...
                    <div class="card leftSide">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append hidemob"
                                                         onclick="ShowConstantModal(6278,'systemUse','الاستعمال التنظيمي')">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group" style="width: 100% !important;">
                                                    ...
                                                    <input type="text" id="pieceNo" name="pieceNo[]"
                                                           class="form-control" placeholder="0000"
                                                           aria-describedby="basic-addon1">
                                                    <a class="add-btn" onclick="addPieceNo();"
                                                       style="margin-left: 0px;padding-top: 9px;padding-right: 9px;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group paddmob">
                                                <div class="input-group" style="width: 94.6% !important;">
                                                    ...
                                                    <div class="input-group-append hidemob"
                                                         onclick="ShowConstantModal(6084,'areaOffice','مكتب مساحة')">
                                                        <span class="input-group-text input-group-text2">
                                                            <i class="fa fa-external-link"></i>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group paddmob">
                                                <div class="input-group" style="width: 94.6% !important;">
                                                    ...
                                                    <div class="input-group-append hidemob"
                                                         onclick="ShowConstantModal(6272,'engOffice','مكتب هندسي')">
                                                        <span class="input-group-text input-group-text2">
                                                            <i class="fa fa-external-link"></i>
                                                        </span>
                                                    </div>
                        ...
                        <div class="col-md-12">
                            <table width="100%" class="detailsTB table archTbl" name="Education"
                                ...
                                <input type="hidden" value="{{$attachesCount}}" name="attachReceive1N"
                                       id="attachReceive1N">
                            </table>
