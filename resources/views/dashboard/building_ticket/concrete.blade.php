                                        ...
                                        <div class="col-md-4" style=" ">
                                            <div class="form-group paddmob">
                                                <div class="input-group" style=" ">
                                                    ...
                                                    <div class="input-group-append hidemob"onclick="ShowConstantModal(6268,'workType','طبيعة العمل')">
                            ...
                            <div class="col-md-7" >
                                <div class="form-group paddmob">
                                    <div class="input-group" style="width: 94.6% !important;">
                                        ...
                                        <div class="input-group-append hidemob"onclick="ShowConstantModal(6269,'implementedCompany','الشركة المنفذة')">
                                            <span class="input-group-text input-group-text2">
                                                <i class="fa fa-external-link"></i>
                                            </span>
                                        </div>
                            ...
                            <div class="col-md-7" >
                                <div class="form-group paddmob">
                                    <div class="input-group" style="width: 94.6% !important;">
                                        ...
                                        <div class="input-group-append hidemob"onclick="ShowConstantModal(6272,'engOffice','المكتب الهندسي')">
                                            <span class="input-group-text input-group-text2">
                                                <i class="fa fa-external-link"></i>
                                            </span>
                                        </div>
