                        ...
                        <div class="card-content collapse show">
                            <div class="card-body" style="padding-bottom: 0px;">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group paddmob">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control fin_desc" name="fin_desc" id="fin_desc" onchange="changeOrders();">
                                                         <!--onchange="$('#AddressDetailsAR2').val($('#fin_desc option:selected').text())"-->
                                                        <option value="">{{"-- إختر --"}}</option>
                                                        <option value="6329"> طاقة شمسية   </option>
                                                        @foreach($fin_desc_list as $fine_desc)
                                                        <option value="{{$fine_desc->id}}"> {{$fine_desc->name}}   </option>
                                                        @endforeach
                                                    </select>

                                                    <div class="input-group-append hidemob" onclick="ShowConstantModal(6326,'fin_desc','وصف المطالبة المالية')" style="cursor:pointer">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group paddmob">
                                                <div class="input-group" style="width: 240px;">
                                                    ...
                                                    <input id="AmountInNIS1" readonly name="AmountInNIS1" class="form-control numFeild "
                                    ...
                                    @include('dashboard.includes.innerFinancialOrder')
...
function changeOrders(){
    if($('#fin_desc').val()=='6329'){
        $('#mytbody').html('');
        orders=`<tr class="solarEnergy">
                <td class="col-sm-4 " style="width: 2%; border: none;">
                    1
                </td>
                <td class="col-sm-4" style="width: 80%;  border: none;">
                    <input type="text" name="itemname[]" id="itemname" class="form-control ac itemname " value=
                    "رسوم خدمات صيانة ونفايات"
                    />
                </td>
            ...
            <tr class="solarEnergy">
                <td class="col-sm-4 " style="width: 2%; border: none;">
                    2
                </td>
                <td class="col-sm-4" style="width: 80%;  border: none;">
                    <input type="text" name="itemname[]" id="itemname" class="form-control ac itemname " value=
                    "رسوم جدولة دين كهرباء"
                    />
                </td>
                <td class="col-sm-4" style="width: 16%; border: none;">
                    <input type="text" name="total[]"  class="form-control" oninput="CalculateColumns('myTable','total[]','totalamount')"/>
            ...
            <tr class="solarEnergy">
                ...
                <td class="col-sm-4" style="width: 80%;  border: none;">
                    <input type="text" name="itemname[]" id="itemname" class="form-control ac itemname " value=
                    "قراءة عدادا الطاقة الشمسية الاستهلاك االاضافي"
                    />
                </td>
                <td class="col-sm-4" style="width: 16%; border: none;">
                    <input type="text" name="total[]"  class="form-control" oninput="CalculateColumns('myTable','total[]','totalamount')"/>
     ...
     $( function(){
        ...
        var table = $('.wtbl').DataTable({
            ...
            ajax:"{{ route('innerFinancial_info_all') }}",
            ...
            columns:[
                    ...
                    },
                    {
                        data: null,
                        render:function(data,row,type){
                                $actionBtn = `<a href='{{route('admin.dashboard')}}/viewTicket/${data.id}/42' style="margin-right:17px;" target="_blank"> ${data.customer_name} </a>`;
                                    return $actionBtn;
                        },
                        name:'customer_name'
                    },
                    ...
                    
                    {
                        data: null,
                        render:function(data,row,type){
                                $actionBtn = `<a href='{{route('admin.dashboard')}}/printTicket/${data.id}/42?flag=0' style="margin-right:17px;" target="_blank"> <img title='print'
