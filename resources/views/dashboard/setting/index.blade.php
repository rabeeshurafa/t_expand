                ...
                <div class="col-sm-12 col-lg-6 col-md-12">
                    <div class="card leftSide">
                        <div class="card-header">
                            <h4 class="card-title"><img src="{{asset('assets/images/ico/info.png')}}" width="32"
                                                        height="32">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12 pr-s-12 pr-0">
                                                    ...
                                                    <img src="https://db.expand.ps/images/call-pinar35.png">
                                                            ...
                                                            <input type="text" id="phone_one" name="phone_one"
                                                                   class="form-control noleft" maxlength="9"
                                        ...
                                        <div class="col-md-4" style="text-align: center;">
                                            <img id="userProfileImg" src="{{$setting->logo}}"
                                            ...
                                            <input type="file" class="form-control-file" id="imgPic" name="imgPic"
                                                   style="display: none" onchange="doUploadPic()" aria-invalid="false">
                                                ...
                                                <div class="col-lg-6 col-md-12 pr-s-12 pr-0">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                    <span class="input-group-text input-group-text1" id="basic-addon1">
                                                    <img src="https://db.expand.ps/images/www35.png"
                                                         style="max-width: 35px;">
                                                    </span>
                                                            </div>
                                                            <input type="text" id="website" name="website"
                                                                   class="form-control noleft"
                                                    ...
                                                    <img src="https://db.expand.ps/images/fax35.png"
                                                         style="max-width: 35px;">
                                                            ...
                                                            <input type="text" id="fax" name="fax"
                                                                   ...
                                                                   placeholder="090000000"
                                                                   aria-describedby="basic-addon1"
                                                                   value="{{$setting->fax}}" style="margin-left: 12px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2 w-s-50" style="padding: 0px;">
                                            <div class="form-group">
                                                <img src="{{asset('assets/images/ico/msg.png')}}"
                                                     onclick="$('#AppModal').modal('show')" style="cursor:pointer">
                                                <div class="form-group">
                                                    <a onclick="$('#AppModal').modal('show')"
                                                       style="color:#000000">{{trans('assets.archive')}}
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body" style="padding-bottom: 0px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{trans('admin.storage_path')}}
                                                ...
                                                <input type="text" id="storage_path" name="storage_path"
                                                       ...
                                                       placeholder="/home4/weexpand/public_html/db.expand"
                                                       aria-describedby="basic-addon1" value="{{$setting->website}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                ...
                                <a href="{{ route('download_backup') }}" class="btn btn-sm btn-primary"><i
                                            class="fa fa-download"></i>Download Backup</a>
                            </div>
                        </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body" style="padding-bottom: 0px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-12 pr-s-12 pr-0">
                                        <div class="form-group">
                                            ...
                                            <span class="input-group-text input-group-text1" id="basic-addon1">
                                                ...
                                                <img id="userHeaderImg" src="{{$setting->header_img}}"
                                                     style="height: 50px; cursor:pointer"
                                                     onclick="document.getElementById('header_img_file').click(); return false">
                                                <input type="file" class="form-control-file" id="header_img_file"
                                                       name="header_img_file" style="display: none"
                                                       onchange="doUploadPic()" aria-invalid="false">
                                    ...
                                    <!--</div>-->
                                    <div class="col-md-4" style="text-align: center;">
                                        <img id="userFooterImg" src="{{$setting->footer_img}}"
                                             style="height: 50px; cursor:pointer"
                                             onclick="document.getElementById('footer_img_file').click(); return false">
                                        <input type="file" class="form-control-file" id="footer_img_file"
                                               name="footer_img_file" style="display: none" onchange="doUploadPic()"
                                               aria-invalid="false">
                                        ...
                                        <div class="row ">
                                            <div class="col-lg-7 col-md-12 pr-0 pr-s-12">
                                                ...
                                                {{trans('admin.working_hours')}}
                                                        ...
                                                        <input type="text" id="WorkinghoursFrom"
                                                               value="{{$setting->WorkinghoursFrom}}"
                                                               class="form-control" placeholder="From: --:--"
                                                               name="WorkinghoursFrom" aria-invalid="false"
                                                               style="border-top-right-radius: 0 !important;border-bottom-right-radius: 0 !important;">

                                                        <input type="text" id="WorkinghoursTo"
                                                               value="{{$setting->WorkinghoursTo}}" class="form-control"
                                                               placeholder="To: --:--" name="WorkinghoursTo"
                                                               aria-invalid="false">
                                            ...
                                            <div class="col-lg-5 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    {{trans('admin.Holidays')}}
                                                        ...
                                                        <input type="text" id="Holidays" class="form-control"
                                                               placeholder="{{trans('admin.Holidays')}}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="alert alert-icon-right alert-warning alert-dismissible mb-2"
                                                    ...
                                                    <strong>ملاحظة !</strong> الحضور من <a class="alert-link">08:00
                                                        صباحا</a> حتى <a class="alert-link">02:00 ظهرا </a> عدا يوم
                                                    الخميس <a class="alert-link">01:00 ظهرا </a>.<br> إظغط <a
                                                            class="alert-link" onclick="$('#timeTable').toggle()">
                                                        هنا </a> لتغيير الإعدادات
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <table style="width:100%" class="detailsTB table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="gray-bg"
                                                                scope="col">{{trans('admin.weekend')}} </th>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from1"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from1" aria-invalid="false"
                                                                       value="{{$setting->from1}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to1"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to1"
                                                                       aria-invalid="false" value="{{$setting->to1}}"
                                                            ...
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           ...
                                                                           onclick="ShowHideDays(1)" value="1">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck1"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from2"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from2" aria-invalid="false"
                                                                       value="{{$setting->from3}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to2"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to2"
                                                                       aria-invalid="false" value="{{$setting->to2}}"
                                                                       autocomplete="off" maxlength="5">
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           ...
                                                                           onclick="ShowHideDays(2)" value="2">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck2"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from3"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from3" aria-invalid="false"
                                                                       value="{{$setting->from3}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to3"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to3"
                                                                       aria-invalid="false" value="{{$setting->to3}}"
                                                                       autocomplete="off" maxlength="5">
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           ...
                                                                           onclick="ShowHideDays(3)" value="3">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck3"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from4"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from4" aria-invalid="false"
                                                                       value="{{$setting->from4}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to4"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to4"
                                                                       aria-invalid="false" value="{{$setting->to4}}"
                                                                       autocomplete="off" maxlength="5">
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           name="customCheck1" id="customCheck4"
                                                                           onclick="ShowHideDays(4)" value="4">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck4"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from5"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from5" aria-invalid="false"
                                                                       value="{{$setting->from5}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to5"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to5"
                                                                       aria-invalid="false" value="{{$setting->to5}}"
                                                                       autocomplete="off" maxlength="5">
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           name="customCheck5" id="customCheck5"
                                                                           onclick="ShowHideDays()" value="5">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck5"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from6"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from6" aria-invalid="false"
                                                                       value="{{$setting->from6}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to6"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to6"
                                                                       aria-invalid="false" value="{{$setting->to6}}"
                                                                       autocomplete="off" maxlength="5">
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           name="customCheck6" id="customCheck6"
                                                                           onclick="ShowHideDays(6)" value="6">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck6"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" id="from7"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30"
                                                                       name="from7" aria-invalid="false"
                                                                       value="{{$setting->from7}}" autocomplete="off"
                                                                       maxlength="5">
                                                            </td>
                                                            <td>
                                                                <input type="text" id="to7"
                                                                       class="form-control simple-field-data-mask"
                                                                       data-mask="00:00" placeholder="07:30" name="to7"
                                                                       aria-invalid="false" value="{{$setting->to7}}"
                                                                       autocomplete="off" maxlength="5">
                                                            </td>
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           name="customCheck7" id="customCheck7"
                                                                           onclick="ShowHideDays(7)" value="7">
                                                                    <label class="custom-control-label"
                                                                           for="customCheck7"> {{trans('admin.weekend')}}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                ...
                                <div class="form-actions" style="border-top:0px; padding-bottom:44px;">
                                    <div class="text-right">
                                        <button type="submit" class="btn btn-primary"
                                                id="saveBtn">{{trans('admin.save')}} <i
                                                    class="ft-thumbs-up position-right"></i></button>
                                        <button type="reset" onclick="redirectURL('linkIcon1-tab1')"
                                        ...
                                        <ul class="nav nav-tabs nav-top-border no-hover-bg nav-justified">
                                            @can('Organization_info')
                                                <li class="nav-item">
                                                    ...
                                                    <a class="nav-link active" style="color: #0073AA;" id="base-tab1"
                                            ...
                                            @can('Organization_law')
                                                <li class="nav-item">
                                                    ...
                                                    <a class="nav-link" style="color: #0073AA;" id="base-tab2"
                                        ...
                                        <div class="tab-content px-1 pt-1" style="margin-top:0px !important ;">
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="ctab1" aria-expanded="true"
                                                ...
                                                <table style="width:100%; margin-top: 10px;direction: rtl;"
                                                       class="detailsTB table hdrTbl1 archivetbl">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col"
                                                            style="text-align: right;color:#ffffff; width: 10px;">#
                                                        </th>

                                                        <th scope="col"
                                                            style="text-align:  right; direction:rtl; font-family: Arial, sans-serif !important;color:#ffffff; width: 150px;">
                                            ...
                                            <div class="tab-pane " id="ctab2" aria-labelledby="base-tab2">
                                                ...
                                                <table style="width:100%; margin-top: 10px;direction: rtl;"
                                                       class="detailsTB table hdrTbl1 lawtbl">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col"
                                                            style="text-align:  right; direction:rtl; font-family: Arial, sans-serif !important;color:#ffffff">
