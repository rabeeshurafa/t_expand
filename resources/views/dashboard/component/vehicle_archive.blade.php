    ...
    */
    ...
    function getContractArchive($id,$contractArchiveCount){
        ...
        var table = $('.lawtbl').DataTable({
            destroy: true,
            ajax: {
                url: '{{ route('vehcileContractArchive') }}',
                data: function (d) {
                    d.vehcile_id = $id;
                }
            },
