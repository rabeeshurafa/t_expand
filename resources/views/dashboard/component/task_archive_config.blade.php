...
<div class="modal fade text-left" id="tableConfigModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1"> 
                       إعدادات مشاركة الطلب مع الموظفين:
                </h4>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-actions" style="border-top:0px; padding-bottom:44px;">
                                                    <div class="text-right">
                                                        <button type="submit" style="background-color: #5599FE !important;border-color: #5599FE !important;" class="btn btn-primary" id="saveBtn">
...
function ShowArchiveConfigModal(bindTo) {
