                                        ...
                                        <div class="card-body" style="padding-bottom: 0px;">
                                            <div class="form-body">
                                                <div class="row mobRow">
                                                    <ol id="ticketRout" style="width: 100%;">
                                                        <li>
                                                            <div class="row">
                                                                <div class="form-group col-md-6">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="reciver_name"
                                                                               class="form-control numFeild modalAC"
                                                                               value="{{ isset($ticketInfo->admin)?$ticketInfo->admin->nick_name:'' }}"
                                                                ...
                                                                <div class="input-group col-md-6"
                                                                    ...
                                                                    <select type="text" id="single_receive"
                                                                            name="single_receive"
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_close_json" name="emp_to_close_json[]"
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_revoke_json" name="emp_to_revoke_json[]"
                                                                class="select2 form-control" multiple="multiple"
                                                                data-toggle="select" style="width:75%;">
                                                            <?php
                                                            if (isset($employees) && !empty($employees) && count($employees) > 0){ ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_update_json" name="emp_to_update_json[]"
                                                                class="select2 form-control" multiple="multiple"
                                                                data-toggle="select" style="width:75%;">
                                                            <?php
                                                            if (isset($employees) && !empty($employees) && count($employees) > 0){ ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_reopen_ticket" name="emp_to_reopen_ticket[]"
                                                                class="select2 form-control" multiple="multiple"
                                                                data-toggle="select" style="width:75%;">
                                                            <?php
                                                            if (isset($employees) && !empty($employees) && count($employees) > 0){ ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_report_ticket" name="emp_to_report_ticket[]"
                                                                class="select2 form-control" multiple="multiple"
                                                                data-toggle="select" style="width:75%;">
                                                            <?php
                                                            if (isset($employees) && !empty($employees) && count($employees) > 0){ ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_tag_ticket" name="emp_to_tag_ticket[]"
                                                                class="select2 form-control" multiple="multiple"
                                                                data-toggle="select" style="width:75%;">
                                                            <?php
                                                            if (isset($employees) && !empty($employees) && count($employees) > 0){ ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <select id="emp_to_access_portal" name="emp_to_access_portal[]"
                                                                class="select2 select2-multiple-input-sm form-control portal"
                                                                multiple="multiple" data-toggle="select"
                                                                style="width:60%;">
                                                            <?php
                                                            if (isset($employees) && !empty($employees) && count($employees) > 0){ ?>
                                                                <?php foreach ($employees as $key => $value){ ?>
                                                ...
                                                <div class="col-md-12"
                                                     style="padding-right: 0px; padding-left: 30px; display:none ">
                                                    <table width="100%" class="detailsTB table archTbl" name="Courses"
                                                           id="Courses">
                                                        <thead>
                                                        <tr>
                                                            <th class="col-md-6"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="col-md-6">
                                                                <input class="form-control" type="text"
                                                                       onclick="adddept()" name="department[]">
                                                            </td>
                                                            <td class="col-md-5">
                                                                <input class="form-control" type="text"
                                                                       name="comment[]">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row mobRow">
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="dept_id" name="dept_id"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                ...
                                                <div class="row mobRow">
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="show_receipt" name="show_receipt"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="receipt_is_need" name="receipt_is_need"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                <div class="row mobRow">
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="has_price_list" name="has_price_list"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="has_debt_list" name="has_debt_list"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                <div class="row mobRow">
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="has_attach" name="has_attach"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="force_attach" name="force_attach"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                <div class="row mobRow">
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="send_sms" name="send_sms"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6 hide"
                                                        ...
                                                        <select type="text" id="apply_for_band_customer"
                                                                name="apply_for_band_customer"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                <div class="row mobRow">
                                                    <div class="input-group col-md-6 hide"
                                                        ...
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"
                                                                  id="basic-addon1">{{"تقديم الطلب فى حال وجود رخص حرف منتهية"}}</span>
                                                        </div>
                                                        <select type="text" id="apply_with_finished_license"
                                                                name="apply_with_finished_license"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="show_archive" name="show_archive"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                <div class="row mobRow">
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="public_app" name="public_app"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="apps_btn" name="apps_btn"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                <div class="row mobRow">
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="joblic_btn" name="joblic_btn"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                    ...
                                                    <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                        ...
                                                        <select type="text" id="can_reply" name="can_reply"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option value="1" {{ $ticketInfo->can_reply==1?'selected':'' }}> {{'نعم'}} </option>
                                                            <option value="2" {{ $ticketInfo->can_reply==2?'selected':'' }}> {{'لا'}} </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row mobRow">
                                                    ...
                                                    <div class="input-group col-md-6 hide"
                                                        ...
                                                        <select type="text" id="show_process" name="show_process"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                    ...
                                                    <div class="input-group col-md-6 hide"
                                                        ...
                                                        <select type="text" id="has_clearance" name="has_clearance"
                                                                class="form-control myselect2"
                                                                aria-invalid="false">
                                                            <option
                                                ...
                                                @if($ticketInfo->ticket_no != 32 && $ticketInfo->ticket_no != 28 && $ticketInfo->ticket_no != 33 && $ticketInfo->ticket_no != 30  && $ticketInfo->ticket_no != 34 && $ticketInfo->ticket_no != 31)
                                                    <div class="row mobRow">
                                                        ...
                                                        <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                            ...
                                                            <select type="text" id="show_nationalID"
                                                                    name="show_nationalID"
                                                                    class="form-control myselect2"
                                                                    aria-invalid="false">
                                                                <option
                                                        ...
                                                        <div class="input-group col-md-6" style=" padding-bottom: 10px">
                                                            ...
                                                            <select type="text" id="required_nationalID"
                                                                    name="required_nationalID"
                                                                    class="form-control myselect2"
                                                                    aria-invalid="false">
                                                                <option
                    ...
                    <div class="col-md-4">
                        <div class="form-group paddmob">
                            <div class="input-group ">
                                ...
                                <select type="text" id="nextDeptId[]" name="nextDeptId[]"
                                        class="form-control deptFlow${flowCount}" aria-invalid="false"
