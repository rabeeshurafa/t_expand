<div class="modal fade text-left" id="msgModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
     aria-hidden="true">
                            ...
                            <div class="form-group">
                                ...
                                <ul class="nav nav-tabs nav-top-border no-hover-bg nav-justified">
                                    ...
                                    @can('folderInArchive')
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" style="color: #0073AA;" id="base-tab3" data-toggle="tab"
                                               aria-controls="ctab3" href="#ctab3" aria-expanded="false">
                                                <b>
                                    ...
                                    @can('folderFinanceArchive')
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" style="color: #0073AA;" id="base-tab7" data-toggle="tab"
                                               aria-controls="ctab7" href="#ctab7" aria-expanded="false">
                                                <b>
                                    ...
                                    @can('folderCopyArchive')
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" style="color: #0073AA;" id="base-tab4" data-toggle="tab"
                                               aria-controls="ctab4" href="#ctab4" aria-expanded="false">
                                                <b>
                                    ...
                                    @can('folderJalArchive')
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" style="color: #0073AA;" id="base-tab5" data-toggle="tab"
                                               aria-controls="ctab5" href="#ctab5" aria-expanded="false">
                                                <b>
                                    ...
                                    @can('folderOtherArchive')
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" style="color: #0073AA;" id="base-tab6" data-toggle="tab"
                                               aria-controls="ctab6" href="#ctab6" aria-expanded="false">
                                                <b>
                                    ...
                                    @can('folderContractArchive')
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" style="color: #0073AA;" id="base-tab2" data-toggle="tab"
                                               aria-controls="ctab2" href="#ctab2" aria-expanded="false">
                                                <b>
                                ...
                                <div class="tab-content px-1 pt-1" style="margin-top:0px !important ;">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="ctab1" aria-expanded="true"
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;" id="archivetbl"
                                    ...
                                    <div class="tab-pane" id="ctab3" aria-labelledby="base-tab3">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;"
                                               class="detailsTB table hdrTbl1 inArchivetbl">
                                    ...
                                    <div class="tab-pane" id="ctab12" aria-labelledby="base-tab12">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;"
                                               class="detailsTB table hdrTbl1 certArchivetbl">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"
                                                    style="width:50px;text-align: right; font-family: Arial, sans-serif !important;color:#ffffff">
                                    ...
                                    <div class="tab-pane" id="ctab7" aria-labelledby="base-tab7">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;"
                                               class="detailsTB table hdrTbl1 financeArchivetbl">
                                    ...
                                    <div class="tab-pane" id="ctab4" aria-labelledby="base-tab4">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;"
                                               class="detailsTB table hdrTbl1 copyArchivetbl">
                                    ...
                                    <div class="tab-pane" id="ctab5" aria-labelledby="base-tab5">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;"
                                               class="detailsTB table hdrTbl1 jalArchivetbl">
                                    ...
                                    <div class="tab-pane" id="ctab6" aria-labelledby="base-tab6">
                                        ...
                                        <table style="width:100%; margin-top: 10px;direction: rtl;"
                                               class="detailsTB table hdrTbl1 other">
...
<script>
  ...
  function getContractArchive($id, $contractArchiveCount) {
    ...
    var table = $('.lawtbl').DataTable({
      destroy: true,
      ajax: {
        url: '{{ route('foldercontractArchive') }}',
        data: function (d) {
          d.id = $id;
        }
      },
