...
@section('content')
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-2 col-sm-12 formnoleft" >
                                            <div class="form-group paddmob">
                                                <div class="input-group widthRegion" style="width: 100% !important;">
                                                    ...
                                                    <select id="AreaID" name="AreaID" type="text" style="height: 38px !important" 
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                            ...
                                            <span class="mx-1">
                                                <input type="checkbox"  class="elecTicket" name="elecTicket" onchange="selectAll('ticketType','1','1','17')">
                                            </span>
                                        ...
                                        <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                            <span class="input-group-text" id="basic-addon1" style="height: 35px">
                                            <span class="mx-1">
                                                <input type="checkbox"  class="elecTicket" name="elecTicket" onchange="selectAll('ticketType','2','1','11')">
                                            </span>
                                        ...
                                        <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                            <span class="input-group-text" id="basic-addon1" style="height: 35px">
                                            <span class="mx-1">
                                                <input type="checkbox"  class="elecTicket" name="elecTicket" onchange="selectAll('ticketType','4','23','27')">
                                            </span>
                                        ...
                                        <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                            <span class="input-group-text" id="basic-addon1" style="height: 35px">
                                            <span class="mx-1">
                                                <input type="checkbox"  class="elecTicket" name="elecTicket" onchange="selectAll('ticketType','5','28','33')">
                                            </span>
                                        ...
                                        <div class="col-lg-2 col-md-12 pr-0 pr-s-12">
                                            <span class="input-group-text" id="basic-addon1" style="height: 35px">
                                            <span class="mx-1">
                                                <input type="checkbox"  class="elecTicket" name="elecTicket" onchange="selectAll('ticketType','farfromcenter','1','2')">
                                            </span>
    ...
    <script>
    function selectAll($class,$type,$first,$last){
        i=$first;
        j=$first;
        $("."+$class).each( function () {

           if($(this).val()==($type+'_'+i))
            {
                if(i != $last)
                    {
                        $(this).click();
