                                            ...
                                            <div class="form-group">
                                                <div class="input-group w-s-87">
                                                    ...
                                                    <select name="arcType" id="OrgType" class="form-control">
                                                        ...
                                                        <option value="depArchive">{{ trans('archive.dep_archive') }}
                                                        </option>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-body">
                            <div class="w-100 pt-1 mb-1 row" style="border-bottom: 1px solid rgb(227, 235, 243);">
                                <div class="col-md-4" >
                                    <div style="font-size:16pt;font-weight:bold">اجمالي مساحة المرفقات : &nbsp;<div class="attachmentSize" style="direction: ltr; display: inline; unicode-bidi: embed;"></div>
                                    </div>
                                </div>
                            </div>
                ...
                success: function(response) {
                    ...
                    if (response.type == "lic") {
                        ...
                        response.data.forEach(elem => {
                            ...
                            $row += '</td>';
                            $row += "<td>" + (+elem?.attachSize !== 0 ? `${elem?.attachSize} mb` : '');
                            $row += "</td></tr>";
                            $('#recListaa').append($row)
                            c++;
                        });
